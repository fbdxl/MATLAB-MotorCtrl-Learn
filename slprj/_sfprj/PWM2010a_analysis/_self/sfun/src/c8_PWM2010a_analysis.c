...
static void initialize_c8_PWM2010a_analysis(SFc8_PWM2010a_analysisInstanceStruct
  *chartInstance);
static void initialize_params_c8_PWM2010a_analysis
  (SFc8_PWM2010a_analysisInstanceStruct *chartInstance);
static void enable_c8_PWM2010a_analysis(SFc8_PWM2010a_analysisInstanceStruct
  *chartInstance);
static void disable_c8_PWM2010a_analysis(SFc8_PWM2010a_analysisInstanceStruct
  *chartInstance);
static void c8_update_debugger_state_c8_PWM2010a_analysis
  (SFc8_PWM2010a_analysisInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c8_PWM2010a_analysis
  (SFc8_PWM2010a_analysisInstanceStruct *chartInstance);
static void set_sim_state_c8_PWM2010a_analysis
  (SFc8_PWM2010a_analysisInstanceStruct *chartInstance, const mxArray *c8_st);
static void finalize_c8_PWM2010a_analysis(SFc8_PWM2010a_analysisInstanceStruct
  *chartInstance);
static void sf_c8_PWM2010a_analysis(SFc8_PWM2010a_analysisInstanceStruct
  *chartInstance);
static void initSimStructsc8_PWM2010a_analysis
  (SFc8_PWM2010a_analysisInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c8_machineNumber, uint32_T
  c8_chartNumber);
static const mxArray *c8_sf_marshallOut(void *chartInstanceVoid, void *c8_inData);
static real_T c8_emlrt_marshallIn(SFc8_PWM2010a_analysisInstanceStruct
  *chartInstance, const mxArray *c8_Vbeta, const char_T *c8_identifier);
static real_T c8_b_emlrt_marshallIn(SFc8_PWM2010a_analysisInstanceStruct
  *chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId);
static void c8_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c8_mxArrayInData, const char_T *c8_varName, void *c8_outData);
static const mxArray *c8_b_sf_marshallOut(void *chartInstanceVoid, void
  *c8_inData);
static int32_T c8_c_emlrt_marshallIn(SFc8_PWM2010a_analysisInstanceStruct
  *chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId);
static void c8_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c8_mxArrayInData, const char_T *c8_varName, void *c8_outData);
static uint8_T c8_d_emlrt_marshallIn(SFc8_PWM2010a_analysisInstanceStruct
  *chartInstance, const mxArray *c8_b_is_active_c8_PWM2010a_analysis, const
  char_T *c8_identifier);
static uint8_T c8_e_emlrt_marshallIn(SFc8_PWM2010a_analysisInstanceStruct
  *chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId);
static void init_dsm_address_info(SFc8_PWM2010a_analysisInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c8_is_active_c8_PWM2010a_analysis = 0U;
}
  ...
  (SFc8_PWM2010a_analysisInstanceStruct *chartInstance)
{
  ...
  c8_c_hoistedGlobal = chartInstance->c8_is_active_c8_PWM2010a_analysis;
  ...
  (SFc8_PWM2010a_analysisInstanceStruct *chartInstance, const mxArray *c8_st)
{
  ...
  *c8_Vbeta = c8_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c8_u,
    1)), "Vbeta");
  chartInstance->c8_is_active_c8_PWM2010a_analysis = c8_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c8_u, 2)),
     "is_active_c8_PWM2010a_analysis");
  sf_mex_destroy(&c8_u);
  c8_update_debugger_state_c8_PWM2010a_analysis(chartInstance);
...
static const mxArray *c8_sf_marshallOut(void *chartInstanceVoid, void *c8_inData)
{
  ...
  const mxArray *c8_y = NULL;
  SFc8_PWM2010a_analysisInstanceStruct *chartInstance;
  chartInstance = (SFc8_PWM2010a_analysisInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c8_PWM2010a_analysis_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c8_identifier)
{
  ...
  c8_y = c8_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c8_b_is_active_c8_PWM2010a_analysis), &c8_thisId);
  sf_mex_destroy(&c8_b_is_active_c8_PWM2010a_analysis);
  return c8_y;
}
...
/* SFunction Glue Code */
void sf_c8_PWM2010a_analysis_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c8_PWM2010a_analysis_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c8_PWM2010a_analysis(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[5],T\"Valpha\",},{M[1],M[8],T\"Vbeta\",},{M[8],M[0],T\"is_active_c8_PWM2010a_analysis\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c8_PWM2010a_analysis_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc8_PWM2010a_analysisInstanceStruct *chartInstance;
    chartInstance = (SFc8_PWM2010a_analysisInstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c8_PWM2010a_analysis(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc8_PWM2010a_analysisInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c8_PWM2010a_analysis((SFc8_PWM2010a_analysisInstanceStruct*)
    chartInstanceVar);
  initialize_c8_PWM2010a_analysis((SFc8_PWM2010a_analysisInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c8_PWM2010a_analysis(void *chartInstanceVar)
{
  enable_c8_PWM2010a_analysis((SFc8_PWM2010a_analysisInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c8_PWM2010a_analysis(void *chartInstanceVar)
{
  disable_c8_PWM2010a_analysis((SFc8_PWM2010a_analysisInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c8_PWM2010a_analysis(void *chartInstanceVar)
{
  sf_c8_PWM2010a_analysis((SFc8_PWM2010a_analysisInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c8_PWM2010a_analysis(SimStruct*
  S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c8_PWM2010a_analysis
    ((SFc8_PWM2010a_analysisInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c8_PWM2010a_analysis();/* state var info */
...
extern void sf_internal_set_sim_state_c8_PWM2010a_analysis(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c8_PWM2010a_analysis((SFc8_PWM2010a_analysisInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c8_PWM2010a_analysis(SimStruct* S)
{
  return sf_internal_get_sim_state_c8_PWM2010a_analysis(S);
}

static void sf_opaque_set_sim_state_c8_PWM2010a_analysis(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c8_PWM2010a_analysis(S, st);
}

static void sf_opaque_terminate_c8_PWM2010a_analysis(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc8_PWM2010a_analysisInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c8_PWM2010a_analysis((SFc8_PWM2010a_analysisInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc8_PWM2010a_analysis((SFc8_PWM2010a_analysisInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c8_PWM2010a_analysis(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c8_PWM2010a_analysis(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c8_PWM2010a_analysis(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c8_PWM2010a_analysis(SimStruct *S)
{
  SFc8_PWM2010a_analysisInstanceStruct *chartInstance;
  chartInstance = (SFc8_PWM2010a_analysisInstanceStruct *)malloc(sizeof
    (SFc8_PWM2010a_analysisInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc8_PWM2010a_analysisInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c8_PWM2010a_analysis;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c8_PWM2010a_analysis;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c8_PWM2010a_analysis;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c8_PWM2010a_analysis;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c8_PWM2010a_analysis;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c8_PWM2010a_analysis;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c8_PWM2010a_analysis;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c8_PWM2010a_analysis;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c8_PWM2010a_analysis;
  chartInstance->chartInfo.mdlStart = mdlStart_c8_PWM2010a_analysis;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c8_PWM2010a_analysis;
...
void c8_PWM2010a_analysis_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c8_PWM2010a_analysis(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c8_PWM2010a_analysis(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c8_PWM2010a_analysis(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c8_PWM2010a_analysis_method_dispatcher.\n"
