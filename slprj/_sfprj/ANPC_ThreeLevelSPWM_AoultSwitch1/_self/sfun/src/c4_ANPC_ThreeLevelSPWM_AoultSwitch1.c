...
#include "ANPC_ThreeLevelSPWM_AoultSwitch1_sfun.h"
#include "c4_ANPC_ThreeLevelSPWM_AoultSwitch1.h"
#include "mwmathutil.h"
#define CHARTINSTANCE_CHARTNUMBER      (chartInstance->chartNumber)
#define CHARTINSTANCE_INSTANCENUMBER   (chartInstance->instanceNumber)
#include "ANPC_ThreeLevelSPWM_AoultSwitch1_sfun_debug_macros.h"
...
static void initialize_c4_ANPC_ThreeLevelSPWM_AoultSwitch1
  (SFc4_ANPC_ThreeLevelSPWM_AoultSwitch1InstanceStruct *chartInstance);
static void initialize_params_c4_ANPC_ThreeLevelSPWM_AoultSwitch1
  (SFc4_ANPC_ThreeLevelSPWM_AoultSwitch1InstanceStruct *chartInstance);
static void enable_c4_ANPC_ThreeLevelSPWM_AoultSwitch1
  (SFc4_ANPC_ThreeLevelSPWM_AoultSwitch1InstanceStruct *chartInstance);
static void disable_c4_ANPC_ThreeLevelSPWM_AoultSwitch1
  (SFc4_ANPC_ThreeLevelSPWM_AoultSwitch1InstanceStruct *chartInstance);
static void c4_update_debugger_state_c4_ANPC_ThreeLevelSPWM_AoultSwitch1
  (SFc4_ANPC_ThreeLevelSPWM_AoultSwitch1InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c4_ANPC_ThreeLevelSPWM_AoultSwitch1
  (SFc4_ANPC_ThreeLevelSPWM_AoultSwitch1InstanceStruct *chartInstance);
static void set_sim_state_c4_ANPC_ThreeLevelSPWM_AoultSwitch1
  (SFc4_ANPC_ThreeLevelSPWM_AoultSwitch1InstanceStruct *chartInstance, const
   mxArray *c4_st);
static void finalize_c4_ANPC_ThreeLevelSPWM_AoultSwitch1
  (SFc4_ANPC_ThreeLevelSPWM_AoultSwitch1InstanceStruct *chartInstance);
static void sf_c4_ANPC_ThreeLevelSPWM_AoultSwitch1
  (SFc4_ANPC_ThreeLevelSPWM_AoultSwitch1InstanceStruct *chartInstance);
static void c4_chartstep_c4_ANPC_ThreeLevelSPWM_AoultSwitch1
  (SFc4_ANPC_ThreeLevelSPWM_AoultSwitch1InstanceStruct *chartInstance);
static void initSimStructsc4_ANPC_ThreeLevelSPWM_AoultSwitch1
  (SFc4_ANPC_ThreeLevelSPWM_AoultSwitch1InstanceStruct *chartInstance);
...
static real_T c4_emlrt_marshallIn
  (SFc4_ANPC_ThreeLevelSPWM_AoultSwitch1InstanceStruct *chartInstance, const
   mxArray *c4_TonCn, const char_T *c4_identifier);
...
static void c4_c_emlrt_marshallIn
  (SFc4_ANPC_ThreeLevelSPWM_AoultSwitch1InstanceStruct *chartInstance, const
   mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId, real_T c4_y[6]);
static void c4_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static void c4_info_helper(c4_ResolvedFunctionInfo c4_info[15]);
static real_T c4_sqrt(SFc4_ANPC_ThreeLevelSPWM_AoultSwitch1InstanceStruct
                      *chartInstance, real_T c4_x);
static void c4_eml_error(SFc4_ANPC_ThreeLevelSPWM_AoultSwitch1InstanceStruct
  *chartInstance);
static void c4_eml_scalar_eg(SFc4_ANPC_ThreeLevelSPWM_AoultSwitch1InstanceStruct
  *chartInstance);
...
static uint8_T c4_e_emlrt_marshallIn
  (SFc4_ANPC_ThreeLevelSPWM_AoultSwitch1InstanceStruct *chartInstance, const
   mxArray *c4_b_is_active_c4_ANPC_ThreeLevelSPWM_AoultSwitch1, const char_T
   *c4_identifier);
static uint8_T c4_f_emlrt_marshallIn
  (SFc4_ANPC_ThreeLevelSPWM_AoultSwitch1InstanceStruct *chartInstance, const
   mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_b_sqrt(SFc4_ANPC_ThreeLevelSPWM_AoultSwitch1InstanceStruct
                      *chartInstance, real_T *c4_x);
  ...
  (SFc4_ANPC_ThreeLevelSPWM_AoultSwitch1InstanceStruct *chartInstance)
{
  ...
  chartInstance->c4_is_active_c4_ANPC_ThreeLevelSPWM_AoultSwitch1 = 0U;
}
  ...
  (SFc4_ANPC_ThreeLevelSPWM_AoultSwitch1InstanceStruct *chartInstance)
{
  ...
  c4_j_hoistedGlobal =
    chartInstance->c4_is_active_c4_ANPC_ThreeLevelSPWM_AoultSwitch1;
   ...
   mxArray *c4_st)
{
  ...
  *c4_TonCp = c4_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c4_u,
  ...
  chartInstance->c4_is_active_c4_ANPC_ThreeLevelSPWM_AoultSwitch1 =
    ...
    "is_active_c4_ANPC_ThreeLevelSPWM_AoultSwitch1");
  sf_mex_destroy(&c4_u);
  c4_update_debugger_state_c4_ANPC_ThreeLevelSPWM_AoultSwitch1(chartInstance);
  ...
  (SFc4_ANPC_ThreeLevelSPWM_AoultSwitch1InstanceStruct *chartInstance)
{
  ...
  chartInstance->c4_sfEvent = CALL_EVENT;
  c4_chartstep_c4_ANPC_ThreeLevelSPWM_AoultSwitch1(chartInstance);
  sf_debug_check_for_state_inconsistency
    (_ANPC_ThreeLevelSPWM_AoultSwitch1MachineNumber_, chartInstance->chartNumber,
  ...
  (SFc4_ANPC_ThreeLevelSPWM_AoultSwitch1InstanceStruct *chartInstance)
{
  ...
  _SFD_EML_CALL(0U, chartInstance->c4_sfEvent, -185);
...
static const mxArray *c4_sf_marshallOut(void *chartInstanceVoid, void *c4_inData)
{
  ...
  const mxArray *c4_y = NULL;
  SFc4_ANPC_ThreeLevelSPWM_AoultSwitch1InstanceStruct *chartInstance;
  chartInstance = (SFc4_ANPC_ThreeLevelSPWM_AoultSwitch1InstanceStruct *)
    chartInstanceVoid;
...
const mxArray
  *sf_c4_ANPC_ThreeLevelSPWM_AoultSwitch1_get_eml_resolved_functions_info(void)
{
   ...
   *c4_identifier)
{
  ...
  c4_y = c4_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c4_b_is_active_c4_ANPC_ThreeLevelSPWM_AoultSwitch1), &c4_thisId);
  sf_mex_destroy(&c4_b_is_active_c4_ANPC_ThreeLevelSPWM_AoultSwitch1);
  return c4_y;
}
...
/* SFunction Glue Code */
void sf_c4_ANPC_ThreeLevelSPWM_AoultSwitch1_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1566725085U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2309745706U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(272850463U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3096164385U);
}

mxArray *sf_c4_ANPC_ThreeLevelSPWM_AoultSwitch1_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("kWzZNcgaT33KCpYQf3w7LD");
...
static const mxArray *sf_get_sim_state_info_c4_ANPC_ThreeLevelSPWM_AoultSwitch1
  (void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x10'type','srcId','name','auxInfo'{{M[1],M[38],T\"TonA23\",},{M[1],M[7],T\"TonAn\",},{M[1],M[6],T\"TonAp\",},{M[1],M[40],T\"TonB23\",},{M[1],M[34],T\"TonBn\",},{M[1],M[4],T\"TonBp\",},{M[1],M[42],T\"TonC23\",},{M[1],M[36],T\"TonCn\",},{M[1],M[35],T\"TonCp\",},{M[8],M[0],T\"is_active_c4_ANPC_ThreeLevelSPWM_AoultSwitch1\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 10, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c4_ANPC_ThreeLevelSPWM_AoultSwitch1_get_check_sum(&mxChecksum);
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        chartAlreadyPresent = sf_debug_initialize_chart
          (_ANPC_ThreeLevelSPWM_AoultSwitch1MachineNumber_,
           4,
           1,
           1,
           21,
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,5561);
        ...
        _SFD_CV_INIT_EML_IF(0,1,11,1895,1904,1914,1931);
        _SFD_CV_INIT_EML_IF(0,1,12,1932,1941,1951,1968);
        _SFD_CV_INIT_EML_IF(0,1,13,1969,1978,1988,2005);
        _SFD_CV_INIT_EML_IF(0,1,14,2007,2030,2531,3005);
        _SFD_CV_INIT_EML_IF(0,1,15,2036,2056,2115,2196);
        _SFD_CV_INIT_EML_IF(0,1,16,2202,2222,2281,2362);
        _SFD_CV_INIT_EML_IF(0,1,17,2368,2388,2447,2528);
        _SFD_CV_INIT_EML_IF(0,1,18,2540,2560,2625,2689);
        _SFD_CV_INIT_EML_IF(0,1,19,2695,2715,2780,2844);
        _SFD_CV_INIT_EML_IF(0,1,20,2850,2870,2935,2999);
        _SFD_CV_INIT_EML_IF(0,1,21,3025,3048,3089,3130);
        _SFD_CV_INIT_EML_IF(0,1,22,3089,3130,3159,3301);
        _SFD_CV_INIT_EML_IF(0,1,23,3159,3210,3233,3301);
        _SFD_CV_INIT_EML_IF(0,1,24,3233,3262,-1,3262);
        _SFD_CV_INIT_EML_IF(0,1,25,3303,3326,3367,3408);
        _SFD_CV_INIT_EML_IF(0,1,26,3367,3408,3437,3579);
        _SFD_CV_INIT_EML_IF(0,1,27,3437,3488,3511,3579);
        _SFD_CV_INIT_EML_IF(0,1,28,3511,3540,-1,3540);
        _SFD_CV_INIT_EML_IF(0,1,29,3581,3605,3647,3690);
        _SFD_CV_INIT_EML_IF(0,1,30,3647,3690,3719,3865);
        _SFD_CV_INIT_EML_IF(0,1,31,3719,3772,3795,3865);
        _SFD_CV_INIT_EML_IF(0,1,32,3795,3825,-1,3825);
        _SFD_CV_INIT_EML_IF(0,1,33,3872,3895,3936,3977);
        _SFD_CV_INIT_EML_IF(0,1,34,3936,3977,4006,4148);
        _SFD_CV_INIT_EML_IF(0,1,35,4006,4057,4080,4148);
        _SFD_CV_INIT_EML_IF(0,1,36,4080,4109,-1,4109);
        _SFD_CV_INIT_EML_IF(0,1,37,4150,4173,4214,4255);
        _SFD_CV_INIT_EML_IF(0,1,38,4214,4255,4284,4426);
        _SFD_CV_INIT_EML_IF(0,1,39,4284,4335,4358,4426);
        _SFD_CV_INIT_EML_IF(0,1,40,4358,4387,-1,4387);
        _SFD_CV_INIT_EML_IF(0,1,41,4428,4452,4494,4537);
        _SFD_CV_INIT_EML_IF(0,1,42,4494,4537,4566,4712);
        _SFD_CV_INIT_EML_IF(0,1,43,4566,4619,4642,4712);
        _SFD_CV_INIT_EML_IF(0,1,44,4642,4672,-1,4672);
        _SFD_CV_INIT_EML_IF(0,1,45,4719,4742,4783,4824);
        _SFD_CV_INIT_EML_IF(0,1,46,4783,4824,4853,4995);
        _SFD_CV_INIT_EML_IF(0,1,47,4853,4904,4927,4995);
        _SFD_CV_INIT_EML_IF(0,1,48,4927,4956,-1,4956);
        _SFD_CV_INIT_EML_IF(0,1,49,4997,5020,5061,5102);
        _SFD_CV_INIT_EML_IF(0,1,50,5061,5102,5131,5273);
        _SFD_CV_INIT_EML_IF(0,1,51,5131,5182,5205,5273);
        _SFD_CV_INIT_EML_IF(0,1,52,5205,5234,-1,5234);
        _SFD_CV_INIT_EML_IF(0,1,53,5275,5299,5341,5384);
        _SFD_CV_INIT_EML_IF(0,1,54,5341,5384,5413,5559);
        _SFD_CV_INIT_EML_IF(0,1,55,5413,5466,5489,5559);
        _SFD_CV_INIT_EML_IF(0,1,56,5489,5519,-1,5519);
        ...
        {
          static int condStart[] = { 3097, 3117 };

          static int condEnd[] = { 3113, 3130 };

          static int pfixExpr[] = { 0, 1, -3 };

          _SFD_CV_INIT_EML_MCDC(0,1,0,3097,3130,2,0,&(condStart[0]),&(condEnd[0]),
                                3,&(pfixExpr[0]));
        }

        {
          static int condStart[] = { 3167, 3190 };

          static int condEnd[] = { 3186, 3210 };

          static int pfixExpr[] = { 0, 1, -3 };

          _SFD_CV_INIT_EML_MCDC(0,1,1,3167,3210,2,2,&(condStart[0]),&(condEnd[0]),
                                3,&(pfixExpr[0]));
        }

        {
          static int condStart[] = { 3375, 3395 };

          static int condEnd[] = { 3391, 3408 };

          static int pfixExpr[] = { 0, 1, -3 };

          _SFD_CV_INIT_EML_MCDC(0,1,2,3375,3408,2,4,&(condStart[0]),&(condEnd[0]),
                                3,&(pfixExpr[0]));
        }

        {
          static int condStart[] = { 3445, 3468 };

          static int condEnd[] = { 3464, 3488 };

          static int pfixExpr[] = { 0, 1, -3 };

          _SFD_CV_INIT_EML_MCDC(0,1,3,3445,3488,2,6,&(condStart[0]),&(condEnd[0]),
                                3,&(pfixExpr[0]));
        }

        {
          static int condStart[] = { 3655, 3676 };

          static int condEnd[] = { 3672, 3690 };

          static int pfixExpr[] = { 0, 1, -3 };

          _SFD_CV_INIT_EML_MCDC(0,1,4,3655,3690,2,8,&(condStart[0]),&(condEnd[0]),
                                3,&(pfixExpr[0]));
        }

        {
          static int condStart[] = { 3727, 3751 };

          static int condEnd[] = { 3747, 3772 };

          static int pfixExpr[] = { 0, 1, -3 };

          _SFD_CV_INIT_EML_MCDC(0,1,5,3727,3772,2,10,&(condStart[0]),&(condEnd[0]),
                                3,&(pfixExpr[0]));
        }

        {
          static int condStart[] = { 3944, 3964 };

          static int condEnd[] = { 3960, 3977 };

          static int pfixExpr[] = { 0, 1, -3 };

          _SFD_CV_INIT_EML_MCDC(0,1,6,3944,3977,2,12,&(condStart[0]),&(condEnd[0]),
                                3,&(pfixExpr[0]));
        }

        {
          static int condStart[] = { 4014, 4037 };

          static int condEnd[] = { 4033, 4057 };

          static int pfixExpr[] = { 0, 1, -3 };

          _SFD_CV_INIT_EML_MCDC(0,1,7,4014,4057,2,14,&(condStart[0]),&(condEnd[0]),
                                3,&(pfixExpr[0]));
        }

        {
          static int condStart[] = { 4222, 4242 };

          static int condEnd[] = { 4238, 4255 };

          static int pfixExpr[] = { 0, 1, -3 };

          _SFD_CV_INIT_EML_MCDC(0,1,8,4222,4255,2,16,&(condStart[0]),&(condEnd[0]),
                                3,&(pfixExpr[0]));
        }

        {
          static int condStart[] = { 4292, 4315 };

          static int condEnd[] = { 4311, 4335 };

          static int pfixExpr[] = { 0, 1, -3 };

          _SFD_CV_INIT_EML_MCDC(0,1,9,4292,4335,2,18,&(condStart[0]),&(condEnd[0]),
                                3,&(pfixExpr[0]));
        }

        {
          static int condStart[] = { 4502, 4523 };

          static int condEnd[] = { 4519, 4537 };

          static int pfixExpr[] = { 0, 1, -3 };

          _SFD_CV_INIT_EML_MCDC(0,1,10,4502,4537,2,20,&(condStart[0]),&(condEnd
            [0]),3,&(pfixExpr[0]));
        }

        {
          static int condStart[] = { 4574, 4598 };

          static int condEnd[] = { 4594, 4619 };

          static int pfixExpr[] = { 0, 1, -3 };

          _SFD_CV_INIT_EML_MCDC(0,1,11,4574,4619,2,22,&(condStart[0]),&(condEnd
            [0]),3,&(pfixExpr[0]));
        }

        {
          static int condStart[] = { 4791, 4811 };

          static int condEnd[] = { 4807, 4824 };

          static int pfixExpr[] = { 0, 1, -3 };

          _SFD_CV_INIT_EML_MCDC(0,1,12,4791,4824,2,24,&(condStart[0]),&(condEnd
            [0]),3,&(pfixExpr[0]));
        }

        {
          static int condStart[] = { 4861, 4884 };

          static int condEnd[] = { 4880, 4904 };

          static int pfixExpr[] = { 0, 1, -3 };

          _SFD_CV_INIT_EML_MCDC(0,1,13,4861,4904,2,26,&(condStart[0]),&(condEnd
            [0]),3,&(pfixExpr[0]));
        }

        {
          static int condStart[] = { 5069, 5089 };

          static int condEnd[] = { 5085, 5102 };

          static int pfixExpr[] = { 0, 1, -3 };

          _SFD_CV_INIT_EML_MCDC(0,1,14,5069,5102,2,28,&(condStart[0]),&(condEnd
            [0]),3,&(pfixExpr[0]));
        }

        {
          static int condStart[] = { 5139, 5162 };

          static int condEnd[] = { 5158, 5182 };

          static int pfixExpr[] = { 0, 1, -3 };

          _SFD_CV_INIT_EML_MCDC(0,1,15,5139,5182,2,30,&(condStart[0]),&(condEnd
            [0]),3,&(pfixExpr[0]));
        }

        {
          ...
          static int condEnd[] = { 5366, 5384 };

          static int pfixExpr[] = { 0, 1, -3 };

          _SFD_CV_INIT_EML_MCDC(0,1,16,5349,5384,2,32,&(condStart[0]),&(condEnd
            [0]),3,&(pfixExpr[0]));
        }

        {
          static int condStart[] = { 5421, 5445 };

          static int condEnd[] = { 5441, 5466 };

          static int pfixExpr[] = { 0, 1, -3 };

          _SFD_CV_INIT_EML_MCDC(0,1,17,5421,5466,2,34,&(condStart[0]),&(condEnd
            [0]),3,&(pfixExpr[0]));
        }
...
{
  return "yKyUj2xGlpor32Mcl1vgLH";
}

static void sf_opaque_initialize_c4_ANPC_ThreeLevelSPWM_AoultSwitch1(void
  *chartInstanceVar)
{
  chart_debug_initialization
    (((SFc4_ANPC_ThreeLevelSPWM_AoultSwitch1InstanceStruct*) chartInstanceVar)
     ->S,0);
  initialize_params_c4_ANPC_ThreeLevelSPWM_AoultSwitch1
    ((SFc4_ANPC_ThreeLevelSPWM_AoultSwitch1InstanceStruct*) chartInstanceVar);
  initialize_c4_ANPC_ThreeLevelSPWM_AoultSwitch1
    ((SFc4_ANPC_ThreeLevelSPWM_AoultSwitch1InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c4_ANPC_ThreeLevelSPWM_AoultSwitch1(void
  *chartInstanceVar)
{
  enable_c4_ANPC_ThreeLevelSPWM_AoultSwitch1
    ((SFc4_ANPC_ThreeLevelSPWM_AoultSwitch1InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c4_ANPC_ThreeLevelSPWM_AoultSwitch1(void
  *chartInstanceVar)
{
  disable_c4_ANPC_ThreeLevelSPWM_AoultSwitch1
    ((SFc4_ANPC_ThreeLevelSPWM_AoultSwitch1InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c4_ANPC_ThreeLevelSPWM_AoultSwitch1(void
  *chartInstanceVar)
{
  sf_c4_ANPC_ThreeLevelSPWM_AoultSwitch1
    ((SFc4_ANPC_ThreeLevelSPWM_AoultSwitch1InstanceStruct*) chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c4_ANPC_ThreeLevelSPWM_AoultSwitch1(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c4_ANPC_ThreeLevelSPWM_AoultSwitch1
    ((SFc4_ANPC_ThreeLevelSPWM_AoultSwitch1InstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c4_ANPC_ThreeLevelSPWM_AoultSwitch1
    ();                                /* state var info */
...
extern void sf_internal_set_sim_state_c4_ANPC_ThreeLevelSPWM_AoultSwitch1
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c4_ANPC_ThreeLevelSPWM_AoultSwitch1
    ((SFc4_ANPC_ThreeLevelSPWM_AoultSwitch1InstanceStruct*)
...
static const mxArray*
  sf_opaque_get_sim_state_c4_ANPC_ThreeLevelSPWM_AoultSwitch1(SimStruct* S)
{
  return sf_internal_get_sim_state_c4_ANPC_ThreeLevelSPWM_AoultSwitch1(S);
}

static void sf_opaque_set_sim_state_c4_ANPC_ThreeLevelSPWM_AoultSwitch1
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c4_ANPC_ThreeLevelSPWM_AoultSwitch1(S, st);
}

static void sf_opaque_terminate_c4_ANPC_ThreeLevelSPWM_AoultSwitch1(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc4_ANPC_ThreeLevelSPWM_AoultSwitch1InstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c4_ANPC_ThreeLevelSPWM_AoultSwitch1
      ((SFc4_ANPC_ThreeLevelSPWM_AoultSwitch1InstanceStruct*) chartInstanceVar);
    free((void *)chartInstanceVar);
    ssSetUserData(S,NULL);
  }

  unload_ANPC_ThreeLevelSPWM_AoultSwitch1_optimization_info();
}

static void sf_opaque_init_subchart_simstructs(void *chartInstanceVar)
{
  initSimStructsc4_ANPC_ThreeLevelSPWM_AoultSwitch1
    ((SFc4_ANPC_ThreeLevelSPWM_AoultSwitch1InstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c4_ANPC_ThreeLevelSPWM_AoultSwitch1(SimStruct
  *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c4_ANPC_ThreeLevelSPWM_AoultSwitch1
      ((SFc4_ANPC_ThreeLevelSPWM_AoultSwitch1InstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c4_ANPC_ThreeLevelSPWM_AoultSwitch1(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct =
      load_ANPC_ThreeLevelSPWM_AoultSwitch1_optimization_info();
  ...
  ssSetChecksum0(S,(1349446145U));
  ssSetChecksum1(S,(3139160888U));
  ssSetChecksum2(S,(1937218923U));
  ssSetChecksum3(S,(214436473U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
}

static void mdlRTW_c4_ANPC_ThreeLevelSPWM_AoultSwitch1(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c4_ANPC_ThreeLevelSPWM_AoultSwitch1(SimStruct *S)
{
  SFc4_ANPC_ThreeLevelSPWM_AoultSwitch1InstanceStruct *chartInstance;
  chartInstance = (SFc4_ANPC_ThreeLevelSPWM_AoultSwitch1InstanceStruct *)malloc
    (sizeof(SFc4_ANPC_ThreeLevelSPWM_AoultSwitch1InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c4_ANPC_ThreeLevelSPWM_AoultSwitch1;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c4_ANPC_ThreeLevelSPWM_AoultSwitch1;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c4_ANPC_ThreeLevelSPWM_AoultSwitch1;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c4_ANPC_ThreeLevelSPWM_AoultSwitch1;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c4_ANPC_ThreeLevelSPWM_AoultSwitch1;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c4_ANPC_ThreeLevelSPWM_AoultSwitch1;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c4_ANPC_ThreeLevelSPWM_AoultSwitch1;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c4_ANPC_ThreeLevelSPWM_AoultSwitch1;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c4_ANPC_ThreeLevelSPWM_AoultSwitch1;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c4_ANPC_ThreeLevelSPWM_AoultSwitch1;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c4_ANPC_ThreeLevelSPWM_AoultSwitch1;
...
void c4_ANPC_ThreeLevelSPWM_AoultSwitch1_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c4_ANPC_ThreeLevelSPWM_AoultSwitch1(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c4_ANPC_ThreeLevelSPWM_AoultSwitch1(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c4_ANPC_ThreeLevelSPWM_AoultSwitch1(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c4_ANPC_ThreeLevelSPWM_AoultSwitch1_method_dispatcher.\n"
