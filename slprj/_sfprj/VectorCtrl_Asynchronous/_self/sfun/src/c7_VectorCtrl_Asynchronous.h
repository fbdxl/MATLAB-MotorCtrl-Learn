#ifndef __c7_VectorCtrl_Asynchronous_h__
#define __c7_VectorCtrl_Asynchronous_h__
...
typedef struct {
  ...
  uint8_T c7_is_active_c7_VectorCtrl_Asynchronous;
  SimStruct *S;
...
extern void c7_VectorCtrl_Asynchronous_method_dispatcher(SimStruct *S, int_T
  method, void *data);
