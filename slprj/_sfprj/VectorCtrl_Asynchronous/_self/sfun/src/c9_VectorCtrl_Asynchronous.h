#ifndef __c9_VectorCtrl_Asynchronous_h__
#define __c9_VectorCtrl_Asynchronous_h__
...
typedef struct {
  ...
  uint8_T c9_is_active_c9_VectorCtrl_Asynchronous;
  SimStruct *S;
...
extern void c9_VectorCtrl_Asynchronous_method_dispatcher(SimStruct *S, int_T
  method, void *data);
