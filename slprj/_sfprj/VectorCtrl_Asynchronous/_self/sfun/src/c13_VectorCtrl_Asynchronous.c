...
static const char * c13_debug_family_names[7] = { "nargin", "nargout", "Valpha",
  "Vbeta", "Va", "Vb", "Vc" };

/* Function Declarations */
static void initialize_c13_VectorCtrl_Asynchronous
  (SFc13_VectorCtrl_AsynchronousInstanceStruct *chartInstance);
static void initialize_params_c13_VectorCtrl_Asynchronous
  (SFc13_VectorCtrl_AsynchronousInstanceStruct *chartInstance);
static void enable_c13_VectorCtrl_Asynchronous
  (SFc13_VectorCtrl_AsynchronousInstanceStruct *chartInstance);
static void disable_c13_VectorCtrl_Asynchronous
  (SFc13_VectorCtrl_AsynchronousInstanceStruct *chartInstance);
static void c13_update_debugger_state_c13_VectorCtrl_Asynchronous
  (SFc13_VectorCtrl_AsynchronousInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c13_VectorCtrl_Asynchronous
  (SFc13_VectorCtrl_AsynchronousInstanceStruct *chartInstance);
static void set_sim_state_c13_VectorCtrl_Asynchronous
  (SFc13_VectorCtrl_AsynchronousInstanceStruct *chartInstance, const mxArray
   *c13_st);
static void finalize_c13_VectorCtrl_Asynchronous
  (SFc13_VectorCtrl_AsynchronousInstanceStruct *chartInstance);
static void sf_c13_VectorCtrl_Asynchronous
  (SFc13_VectorCtrl_AsynchronousInstanceStruct *chartInstance);
static void initSimStructsc13_VectorCtrl_Asynchronous
  (SFc13_VectorCtrl_AsynchronousInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c13_machineNumber, uint32_T
  c13_chartNumber);
static const mxArray *c13_sf_marshallOut(void *chartInstanceVoid, void
  *c13_inData);
static real_T c13_emlrt_marshallIn(SFc13_VectorCtrl_AsynchronousInstanceStruct
  *chartInstance, const mxArray *c13_Vc, const char_T *c13_identifier);
static real_T c13_b_emlrt_marshallIn(SFc13_VectorCtrl_AsynchronousInstanceStruct
...
static uint8_T c13_d_emlrt_marshallIn
  (SFc13_VectorCtrl_AsynchronousInstanceStruct *chartInstance, const mxArray
   *c13_b_is_active_c13_VectorCtrl_Asynchronous, const char_T *c13_identifier);
static uint8_T c13_e_emlrt_marshallIn
  (SFc13_VectorCtrl_AsynchronousInstanceStruct *chartInstance, const mxArray
   *c13_u, const emlrtMsgIdentifier *c13_parentId);
static void init_dsm_address_info(SFc13_VectorCtrl_AsynchronousInstanceStruct
  *chartInstance);
  ...
  (SFc13_VectorCtrl_AsynchronousInstanceStruct *chartInstance)
{
  ...
  chartInstance->c13_is_active_c13_VectorCtrl_Asynchronous = 0U;
}
  ...
  (SFc13_VectorCtrl_AsynchronousInstanceStruct *chartInstance)
{
  ...
  c13_d_hoistedGlobal = chartInstance->c13_is_active_c13_VectorCtrl_Asynchronous;
   ...
   *c13_st)
{
  ...
  *c13_Va = c13_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c13_u,
    0)), "Va");
  *c13_Vb = c13_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c13_u,
    1)), "Vb");
  *c13_Vc = c13_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c13_u,
    2)), "Vc");
  chartInstance->c13_is_active_c13_VectorCtrl_Asynchronous =
    c13_d_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c13_u, 3)),
    "is_active_c13_VectorCtrl_Asynchronous");
  sf_mex_destroy(&c13_u);
  c13_update_debugger_state_c13_VectorCtrl_Asynchronous(chartInstance);
  ...
  (SFc13_VectorCtrl_AsynchronousInstanceStruct *chartInstance)
{
  ...
  real_T *c13_b_Vbeta;
  real_T *c13_b_Valpha;
  c13_b_Vbeta = (real_T *)ssGetInputPortSignal(chartInstance->S, 1);
  c13_b_Vc = (real_T *)ssGetOutputPortSignal(chartInstance->S, 3);
  c13_b_Vb = (real_T *)ssGetOutputPortSignal(chartInstance->S, 2);
  c13_b_Valpha = (real_T *)ssGetInputPortSignal(chartInstance->S, 0);
  c13_b_Va = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  ...
  c13_hoistedGlobal = *c13_b_Valpha;
  c13_b_hoistedGlobal = *c13_b_Vbeta;
  c13_Valpha = c13_hoistedGlobal;
  c13_Vbeta = c13_b_hoistedGlobal;
  ...
  sf_debug_symbol_scope_add_eml_importable(&c13_nargout, 1U, c13_sf_marshallOut,
    c13_sf_marshallIn);
  sf_debug_symbol_scope_add_eml(&c13_Valpha, 2U, c13_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c13_Vbeta, 3U, c13_sf_marshallOut);
  sf_debug_symbol_scope_add_eml_importable(&c13_Va, 4U, c13_sf_marshallOut,
    c13_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c13_Vb, 5U, c13_sf_marshallOut,
    c13_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c13_Vc, 6U, c13_sf_marshallOut,
    c13_sf_marshallIn);
  CV_EML_FCN(0, 0);
  _SFD_EML_CALL(0U, chartInstance->c13_sfEvent, 3);
  c13_b = c13_Valpha;
  c13_Va = 0.816496580927726 * c13_b;
  _SFD_EML_CALL(0U, chartInstance->c13_sfEvent, 4);
  c13_A = -c13_Valpha;
  c13_x = c13_A;
  c13_b_x = c13_x;
  c13_y = c13_b_x / 2.4494897427831779;
  c13_b_A = c13_Vbeta;
  c13_c_x = c13_b_A;
  c13_d_x = c13_c_x;
  c13_b_y = c13_d_x / 1.4142135623730951;
  c13_Vb = c13_y + c13_b_y;
  _SFD_EML_CALL(0U, chartInstance->c13_sfEvent, 5);
  c13_c_A = -c13_Valpha;
  c13_e_x = c13_c_A;
  c13_f_x = c13_e_x;
  c13_c_y = c13_f_x / 2.4494897427831779;
  c13_d_A = c13_Vbeta;
  c13_g_x = c13_d_A;
  c13_h_x = c13_g_x;
  c13_d_y = c13_h_x / 1.4142135623730951;
  c13_Vc = c13_c_y - c13_d_y;
  _SFD_EML_CALL(0U, chartInstance->c13_sfEvent, -5);
  ...
  *c13_inData)
{
  ...
  const mxArray *c13_y = NULL;
  SFc13_VectorCtrl_AsynchronousInstanceStruct *chartInstance;
  chartInstance = (SFc13_VectorCtrl_AsynchronousInstanceStruct *)
    chartInstanceVoid;
  ...
  *chartInstance, const mxArray *c13_Vc, const char_T *c13_identifier)
{
  ...
  c13_y = c13_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c13_Vc), &c13_thisId);
  sf_mex_destroy(&c13_Vc);
  return c13_y;
}
  ...
  *c13_mxArrayInData, const char_T *c13_varName, void *c13_outData)
{
  ...
  chartInstance = (SFc13_VectorCtrl_AsynchronousInstanceStruct *)
    chartInstanceVoid;
  c13_Vc = sf_mex_dup(c13_mxArrayInData);
...
const mxArray *sf_c13_VectorCtrl_Asynchronous_get_eml_resolved_functions_info
  (void)
{
   ...
   *c13_b_is_active_c13_VectorCtrl_Asynchronous, const char_T *c13_identifier)
{
  ...
  c13_y = c13_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c13_b_is_active_c13_VectorCtrl_Asynchronous), &c13_thisId);
  sf_mex_destroy(&c13_b_is_active_c13_VectorCtrl_Asynchronous);
  return c13_y;
}
...
/* SFunction Glue Code */
void sf_c13_VectorCtrl_Asynchronous_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c13_VectorCtrl_Asynchronous_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c13_VectorCtrl_Asynchronous(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x4'type','srcId','name','auxInfo'{{M[1],M[4],T\"Va\",},{M[1],M[6],T\"Vb\",},{M[1],M[7],T\"Vc\",},{M[8],M[0],T\"is_active_c13_VectorCtrl_Asynchronous\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 4, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c13_VectorCtrl_Asynchronous_get_check_sum(&mxChecksum);
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
...

        {
          ...
          real_T *c13_Vc;
          real_T *c13_Vbeta;
          c13_Vbeta = (real_T *)ssGetInputPortSignal(chartInstance->S, 1);
          c13_Vc = (real_T *)ssGetOutputPortSignal(chartInstance->S, 3);
          c13_Vb = (real_T *)ssGetOutputPortSignal(chartInstance->S, 2);
          c13_Valpha = (real_T *)ssGetInputPortSignal(chartInstance->S, 0);
          c13_Va = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
...
static void sf_opaque_initialize_c13_VectorCtrl_Asynchronous(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc13_VectorCtrl_AsynchronousInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c13_VectorCtrl_Asynchronous
    ((SFc13_VectorCtrl_AsynchronousInstanceStruct*) chartInstanceVar);
  initialize_c13_VectorCtrl_Asynchronous
    ((SFc13_VectorCtrl_AsynchronousInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c13_VectorCtrl_Asynchronous(void *chartInstanceVar)
{
  enable_c13_VectorCtrl_Asynchronous
    ((SFc13_VectorCtrl_AsynchronousInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c13_VectorCtrl_Asynchronous(void *chartInstanceVar)
{
  disable_c13_VectorCtrl_Asynchronous
    ((SFc13_VectorCtrl_AsynchronousInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c13_VectorCtrl_Asynchronous(void *chartInstanceVar)
{
  sf_c13_VectorCtrl_Asynchronous((SFc13_VectorCtrl_AsynchronousInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c13_VectorCtrl_Asynchronous
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c13_VectorCtrl_Asynchronous
    ((SFc13_VectorCtrl_AsynchronousInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c13_VectorCtrl_Asynchronous();/* state var info */
...
extern void sf_internal_set_sim_state_c13_VectorCtrl_Asynchronous(SimStruct* S,
  const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c13_VectorCtrl_Asynchronous
    ((SFc13_VectorCtrl_AsynchronousInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c13_VectorCtrl_Asynchronous
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c13_VectorCtrl_Asynchronous(S);
}

static void sf_opaque_set_sim_state_c13_VectorCtrl_Asynchronous(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c13_VectorCtrl_Asynchronous(S, st);
}

static void sf_opaque_terminate_c13_VectorCtrl_Asynchronous(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc13_VectorCtrl_AsynchronousInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c13_VectorCtrl_Asynchronous
      ((SFc13_VectorCtrl_AsynchronousInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc13_VectorCtrl_Asynchronous
    ((SFc13_VectorCtrl_AsynchronousInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c13_VectorCtrl_Asynchronous(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c13_VectorCtrl_Asynchronous
      ((SFc13_VectorCtrl_AsynchronousInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c13_VectorCtrl_Asynchronous(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c13_VectorCtrl_Asynchronous(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c13_VectorCtrl_Asynchronous(SimStruct *S)
{
  SFc13_VectorCtrl_AsynchronousInstanceStruct *chartInstance;
  chartInstance = (SFc13_VectorCtrl_AsynchronousInstanceStruct *)malloc(sizeof
    (SFc13_VectorCtrl_AsynchronousInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc13_VectorCtrl_AsynchronousInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c13_VectorCtrl_Asynchronous;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c13_VectorCtrl_Asynchronous;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c13_VectorCtrl_Asynchronous;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c13_VectorCtrl_Asynchronous;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c13_VectorCtrl_Asynchronous;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c13_VectorCtrl_Asynchronous;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c13_VectorCtrl_Asynchronous;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c13_VectorCtrl_Asynchronous;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c13_VectorCtrl_Asynchronous;
  chartInstance->chartInfo.mdlStart = mdlStart_c13_VectorCtrl_Asynchronous;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c13_VectorCtrl_Asynchronous;
...
void c13_VectorCtrl_Asynchronous_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c13_VectorCtrl_Asynchronous(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c13_VectorCtrl_Asynchronous(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c13_VectorCtrl_Asynchronous(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c13_VectorCtrl_Asynchronous_method_dispatcher.\n"
