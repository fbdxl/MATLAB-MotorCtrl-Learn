...
static void initialize_c17_VectorCtrl_Asynchronous
  (SFc17_VectorCtrl_AsynchronousInstanceStruct *chartInstance);
static void initialize_params_c17_VectorCtrl_Asynchronous
  (SFc17_VectorCtrl_AsynchronousInstanceStruct *chartInstance);
static void enable_c17_VectorCtrl_Asynchronous
  (SFc17_VectorCtrl_AsynchronousInstanceStruct *chartInstance);
static void disable_c17_VectorCtrl_Asynchronous
  (SFc17_VectorCtrl_AsynchronousInstanceStruct *chartInstance);
static void c17_update_debugger_state_c17_VectorCtrl_Asynchronous
  (SFc17_VectorCtrl_AsynchronousInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c17_VectorCtrl_Asynchronous
  (SFc17_VectorCtrl_AsynchronousInstanceStruct *chartInstance);
static void set_sim_state_c17_VectorCtrl_Asynchronous
  (SFc17_VectorCtrl_AsynchronousInstanceStruct *chartInstance, const mxArray
   *c17_st);
static void finalize_c17_VectorCtrl_Asynchronous
  (SFc17_VectorCtrl_AsynchronousInstanceStruct *chartInstance);
static void sf_c17_VectorCtrl_Asynchronous
  (SFc17_VectorCtrl_AsynchronousInstanceStruct *chartInstance);
static void initSimStructsc17_VectorCtrl_Asynchronous
  (SFc17_VectorCtrl_AsynchronousInstanceStruct *chartInstance);
...
static const mxArray *c17_sf_marshallOut(void *chartInstanceVoid, void
  *c17_inData);
static real_T c17_emlrt_marshallIn(SFc17_VectorCtrl_AsynchronousInstanceStruct
  *chartInstance, const mxArray *c17_Vbeta, const char_T *c17_identifier);
static real_T c17_b_emlrt_marshallIn(SFc17_VectorCtrl_AsynchronousInstanceStruct
...
static uint8_T c17_d_emlrt_marshallIn
  (SFc17_VectorCtrl_AsynchronousInstanceStruct *chartInstance, const mxArray
   *c17_b_is_active_c17_VectorCtrl_Asynchronous, const char_T *c17_identifier);
static uint8_T c17_e_emlrt_marshallIn
  (SFc17_VectorCtrl_AsynchronousInstanceStruct *chartInstance, const mxArray
   *c17_u, const emlrtMsgIdentifier *c17_parentId);
static void init_dsm_address_info(SFc17_VectorCtrl_AsynchronousInstanceStruct
  *chartInstance);
  ...
  (SFc17_VectorCtrl_AsynchronousInstanceStruct *chartInstance)
{
  ...
  chartInstance->c17_is_active_c17_VectorCtrl_Asynchronous = 0U;
}
  ...
  (SFc17_VectorCtrl_AsynchronousInstanceStruct *chartInstance)
{
  ...
  c17_c_hoistedGlobal = chartInstance->c17_is_active_c17_VectorCtrl_Asynchronous;
   ...
   *c17_st)
{
  ...
  *c17_Vbeta = c17_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c17_u, 1)), "Vbeta");
  chartInstance->c17_is_active_c17_VectorCtrl_Asynchronous =
    c17_d_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c17_u, 2)),
    "is_active_c17_VectorCtrl_Asynchronous");
  sf_mex_destroy(&c17_u);
  c17_update_debugger_state_c17_VectorCtrl_Asynchronous(chartInstance);
  ...
  *c17_inData)
{
  ...
  const mxArray *c17_y = NULL;
  SFc17_VectorCtrl_AsynchronousInstanceStruct *chartInstance;
  chartInstance = (SFc17_VectorCtrl_AsynchronousInstanceStruct *)
    chartInstanceVoid;
...
const mxArray *sf_c17_VectorCtrl_Asynchronous_get_eml_resolved_functions_info
  (void)
{
   ...
   *c17_b_is_active_c17_VectorCtrl_Asynchronous, const char_T *c17_identifier)
{
  ...
  c17_y = c17_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c17_b_is_active_c17_VectorCtrl_Asynchronous), &c17_thisId);
  sf_mex_destroy(&c17_b_is_active_c17_VectorCtrl_Asynchronous);
  return c17_y;
}
...
/* SFunction Glue Code */
void sf_c17_VectorCtrl_Asynchronous_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c17_VectorCtrl_Asynchronous_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c17_VectorCtrl_Asynchronous(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[4],T\"Valpha\",},{M[1],M[6],T\"Vbeta\",},{M[8],M[0],T\"is_active_c17_VectorCtrl_Asynchronous\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c17_VectorCtrl_Asynchronous_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c17_VectorCtrl_Asynchronous(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc17_VectorCtrl_AsynchronousInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c17_VectorCtrl_Asynchronous
    ((SFc17_VectorCtrl_AsynchronousInstanceStruct*) chartInstanceVar);
  initialize_c17_VectorCtrl_Asynchronous
    ((SFc17_VectorCtrl_AsynchronousInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c17_VectorCtrl_Asynchronous(void *chartInstanceVar)
{
  enable_c17_VectorCtrl_Asynchronous
    ((SFc17_VectorCtrl_AsynchronousInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c17_VectorCtrl_Asynchronous(void *chartInstanceVar)
{
  disable_c17_VectorCtrl_Asynchronous
    ((SFc17_VectorCtrl_AsynchronousInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c17_VectorCtrl_Asynchronous(void *chartInstanceVar)
{
  sf_c17_VectorCtrl_Asynchronous((SFc17_VectorCtrl_AsynchronousInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c17_VectorCtrl_Asynchronous
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c17_VectorCtrl_Asynchronous
    ((SFc17_VectorCtrl_AsynchronousInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c17_VectorCtrl_Asynchronous();/* state var info */
...
extern void sf_internal_set_sim_state_c17_VectorCtrl_Asynchronous(SimStruct* S,
  const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c17_VectorCtrl_Asynchronous
    ((SFc17_VectorCtrl_AsynchronousInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c17_VectorCtrl_Asynchronous
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c17_VectorCtrl_Asynchronous(S);
}

static void sf_opaque_set_sim_state_c17_VectorCtrl_Asynchronous(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c17_VectorCtrl_Asynchronous(S, st);
}

static void sf_opaque_terminate_c17_VectorCtrl_Asynchronous(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc17_VectorCtrl_AsynchronousInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c17_VectorCtrl_Asynchronous
      ((SFc17_VectorCtrl_AsynchronousInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc17_VectorCtrl_Asynchronous
    ((SFc17_VectorCtrl_AsynchronousInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c17_VectorCtrl_Asynchronous(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c17_VectorCtrl_Asynchronous
      ((SFc17_VectorCtrl_AsynchronousInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c17_VectorCtrl_Asynchronous(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c17_VectorCtrl_Asynchronous(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c17_VectorCtrl_Asynchronous(SimStruct *S)
{
  SFc17_VectorCtrl_AsynchronousInstanceStruct *chartInstance;
  chartInstance = (SFc17_VectorCtrl_AsynchronousInstanceStruct *)malloc(sizeof
    (SFc17_VectorCtrl_AsynchronousInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc17_VectorCtrl_AsynchronousInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c17_VectorCtrl_Asynchronous;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c17_VectorCtrl_Asynchronous;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c17_VectorCtrl_Asynchronous;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c17_VectorCtrl_Asynchronous;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c17_VectorCtrl_Asynchronous;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c17_VectorCtrl_Asynchronous;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c17_VectorCtrl_Asynchronous;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c17_VectorCtrl_Asynchronous;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c17_VectorCtrl_Asynchronous;
  chartInstance->chartInfo.mdlStart = mdlStart_c17_VectorCtrl_Asynchronous;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c17_VectorCtrl_Asynchronous;
...
void c17_VectorCtrl_Asynchronous_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c17_VectorCtrl_Asynchronous(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c17_VectorCtrl_Asynchronous(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c17_VectorCtrl_Asynchronous(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c17_VectorCtrl_Asynchronous_method_dispatcher.\n"
