#ifndef __c4_VectorCtrl_Asynchronous_h__
#define __c4_VectorCtrl_Asynchronous_h__
...
typedef struct {
  ...
  uint8_T c4_is_active_c4_VectorCtrl_Asynchronous;
  SimStruct *S;
...
extern void c4_VectorCtrl_Asynchronous_method_dispatcher(SimStruct *S, int_T
  method, void *data);
