#ifndef __c8_VectorCtrl_Asynchronous_h__
#define __c8_VectorCtrl_Asynchronous_h__
...
typedef struct {
  ...
  uint8_T c8_is_active_c8_VectorCtrl_Asynchronous;
  SimStruct *S;
...
extern void c8_VectorCtrl_Asynchronous_method_dispatcher(SimStruct *S, int_T
  method, void *data);
