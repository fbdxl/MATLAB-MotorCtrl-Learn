...
static void initialize_c9_Vector_Control_SVPWM_encoderless_learn
  (SFc9_Vector_Control_SVPWM_encoderless_learnInstanceStruct *chartInstance);
static void initialize_params_c9_Vector_Control_SVPWM_encoderless_learn
  (SFc9_Vector_Control_SVPWM_encoderless_learnInstanceStruct *chartInstance);
static void enable_c9_Vector_Control_SVPWM_encoderless_learn
  (SFc9_Vector_Control_SVPWM_encoderless_learnInstanceStruct *chartInstance);
static void disable_c9_Vector_Control_SVPWM_encoderless_learn
  (SFc9_Vector_Control_SVPWM_encoderless_learnInstanceStruct *chartInstance);
static void c9_update_debugger_state_c9_Vector_Control_SVPWM_encoderless_lea
  (SFc9_Vector_Control_SVPWM_encoderless_learnInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c9_Vector_Control_SVPWM_encoderless_learn
  (SFc9_Vector_Control_SVPWM_encoderless_learnInstanceStruct *chartInstance);
static void set_sim_state_c9_Vector_Control_SVPWM_encoderless_learn
  (SFc9_Vector_Control_SVPWM_encoderless_learnInstanceStruct *chartInstance,
   const mxArray *c9_st);
static void finalize_c9_Vector_Control_SVPWM_encoderless_learn
  (SFc9_Vector_Control_SVPWM_encoderless_learnInstanceStruct *chartInstance);
static void sf_c9_Vector_Control_SVPWM_encoderless_learn
  (SFc9_Vector_Control_SVPWM_encoderless_learnInstanceStruct *chartInstance);
static void initSimStructsc9_Vector_Control_SVPWM_encoderless_learn
  (SFc9_Vector_Control_SVPWM_encoderless_learnInstanceStruct *chartInstance);
...
static real_T c9_emlrt_marshallIn
  (SFc9_Vector_Control_SVPWM_encoderless_learnInstanceStruct *chartInstance,
   const mxArray *c9_Vq, const char_T *c9_identifier);
...
static uint8_T c9_d_emlrt_marshallIn
  (SFc9_Vector_Control_SVPWM_encoderless_learnInstanceStruct *chartInstance,
   const mxArray *c9_b_is_active_c9_Vector_Control_SVPWM_encoderless_learn,
  ...
  (SFc9_Vector_Control_SVPWM_encoderless_learnInstanceStruct *chartInstance)
{
  ...
  chartInstance->c9_is_active_c9_Vector_Control_SVPWM_encoderless_learn = 0U;
}
  ...
  (SFc9_Vector_Control_SVPWM_encoderless_learnInstanceStruct *chartInstance)
{
  ...
  c9_c_hoistedGlobal =
    chartInstance->c9_is_active_c9_Vector_Control_SVPWM_encoderless_learn;
   ...
   const mxArray *c9_st)
{
  ...
  *c9_Vq = c9_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c9_u, 1)),
    "Vq");
  chartInstance->c9_is_active_c9_Vector_Control_SVPWM_encoderless_learn =
    c9_d_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c9_u, 2)),
    "is_active_c9_Vector_Control_SVPWM_encoderless_learn");
  sf_mex_destroy(&c9_u);
  c9_update_debugger_state_c9_Vector_Control_SVPWM_encoderless_lea(chartInstance);
...
static const mxArray *c9_sf_marshallOut(void *chartInstanceVoid, void *c9_inData)
{
  ...
  const mxArray *c9_y = NULL;
  SFc9_Vector_Control_SVPWM_encoderless_learnInstanceStruct *chartInstance;
  chartInstance = (SFc9_Vector_Control_SVPWM_encoderless_learnInstanceStruct *)
    chartInstanceVoid;
   ...
   const char_T *c9_identifier)
{
  ...
  c9_y = c9_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c9_b_is_active_c9_Vector_Control_SVPWM_encoderless_learn), &c9_thisId);
  sf_mex_destroy(&c9_b_is_active_c9_Vector_Control_SVPWM_encoderless_learn);
  return c9_y;
}
...
/* SFunction Glue Code */
void sf_c9_Vector_Control_SVPWM_encoderless_learn_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c9_Vector_Control_SVPWM_encoderless_learn_get_autoinheritance_info
  (void)
{
...
static const mxArray
  *sf_get_sim_state_info_c9_Vector_Control_SVPWM_encoderless_learn(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[5],T\"Vd\",},{M[1],M[7],T\"Vq\",},{M[8],M[0],T\"is_active_c9_Vector_Control_SVPWM_encoderless_learn\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c9_Vector_Control_SVPWM_encoderless_learn_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c9_Vector_Control_SVPWM_encoderless_learn(void *
  chartInstanceVar)
{
  chart_debug_initialization
    (((SFc9_Vector_Control_SVPWM_encoderless_learnInstanceStruct*)
      chartInstanceVar)->S,0);
  initialize_params_c9_Vector_Control_SVPWM_encoderless_learn
    ((SFc9_Vector_Control_SVPWM_encoderless_learnInstanceStruct*)
     chartInstanceVar);
  initialize_c9_Vector_Control_SVPWM_encoderless_learn
    ((SFc9_Vector_Control_SVPWM_encoderless_learnInstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_enable_c9_Vector_Control_SVPWM_encoderless_learn(void
  *chartInstanceVar)
{
  enable_c9_Vector_Control_SVPWM_encoderless_learn
    ((SFc9_Vector_Control_SVPWM_encoderless_learnInstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_disable_c9_Vector_Control_SVPWM_encoderless_learn(void
  *chartInstanceVar)
{
  disable_c9_Vector_Control_SVPWM_encoderless_learn
    ((SFc9_Vector_Control_SVPWM_encoderless_learnInstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_gateway_c9_Vector_Control_SVPWM_encoderless_learn(void
  *chartInstanceVar)
{
  sf_c9_Vector_Control_SVPWM_encoderless_learn
    ((SFc9_Vector_Control_SVPWM_encoderless_learnInstanceStruct*)
     chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c9_Vector_Control_SVPWM_encoderless_learn(SimStruct*
  S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c9_Vector_Control_SVPWM_encoderless_learn
    ((SFc9_Vector_Control_SVPWM_encoderless_learnInstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
  prhs[3] = (mxArray*)
    sf_get_sim_state_info_c9_Vector_Control_SVPWM_encoderless_learn();/* state var info */
...
extern void sf_internal_set_sim_state_c9_Vector_Control_SVPWM_encoderless_learn
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c9_Vector_Control_SVPWM_encoderless_learn
    ((SFc9_Vector_Control_SVPWM_encoderless_learnInstanceStruct*)
...
static const mxArray*
  sf_opaque_get_sim_state_c9_Vector_Control_SVPWM_encoderless_learn(SimStruct* S)
{
  return sf_internal_get_sim_state_c9_Vector_Control_SVPWM_encoderless_learn(S);
}

static void sf_opaque_set_sim_state_c9_Vector_Control_SVPWM_encoderless_learn
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c9_Vector_Control_SVPWM_encoderless_learn(S, st);
}

static void sf_opaque_terminate_c9_Vector_Control_SVPWM_encoderless_learn(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc9_Vector_Control_SVPWM_encoderless_learnInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c9_Vector_Control_SVPWM_encoderless_learn
      ((SFc9_Vector_Control_SVPWM_encoderless_learnInstanceStruct*)
       chartInstanceVar);
...
{
  initSimStructsc9_Vector_Control_SVPWM_encoderless_learn
    ((SFc9_Vector_Control_SVPWM_encoderless_learnInstanceStruct*)
     chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c9_Vector_Control_SVPWM_encoderless_learn
  (SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c9_Vector_Control_SVPWM_encoderless_learn(SimStruct
  *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct =
...
static void mdlRTW_c9_Vector_Control_SVPWM_encoderless_learn(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c9_Vector_Control_SVPWM_encoderless_learn(SimStruct *S)
{
  SFc9_Vector_Control_SVPWM_encoderless_learnInstanceStruct *chartInstance;
  chartInstance = (SFc9_Vector_Control_SVPWM_encoderless_learnInstanceStruct *)
    malloc(sizeof(SFc9_Vector_Control_SVPWM_encoderless_learnInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c9_Vector_Control_SVPWM_encoderless_learn;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c9_Vector_Control_SVPWM_encoderless_learn;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c9_Vector_Control_SVPWM_encoderless_learn;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c9_Vector_Control_SVPWM_encoderless_learn;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c9_Vector_Control_SVPWM_encoderless_learn;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c9_Vector_Control_SVPWM_encoderless_learn;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c9_Vector_Control_SVPWM_encoderless_learn;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c9_Vector_Control_SVPWM_encoderless_learn;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW =
    mdlRTW_c9_Vector_Control_SVPWM_encoderless_learn;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c9_Vector_Control_SVPWM_encoderless_learn;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c9_Vector_Control_SVPWM_encoderless_learn;
...
void c9_Vector_Control_SVPWM_encoderless_learn_method_dispatcher(SimStruct *S,
  int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c9_Vector_Control_SVPWM_encoderless_learn(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c9_Vector_Control_SVPWM_encoderless_learn(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c9_Vector_Control_SVPWM_encoderless_learn(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c9_Vector_Control_SVPWM_encoderless_learn_method_dispatcher.\n"
