...
{
  extern unsigned int
    sf_Vector_Control_SVPWM_encoderless_learn_process_check_sum_call( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_Vector_Control_SVPWM_encoderless_learn_process_check_sum_call(nlhs,plhs,
       nrhs,prhs))
    return 1;
  return 0;
}
...
{
  extern unsigned int
    sf_Vector_Control_SVPWM_encoderless_learn_autoinheritance_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  ...
  if (strcmp(machineName, "Vector_Control_SVPWM_encoderless_learn") == 0) {
    const mxArray *newRhs[3] = { NULL, NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_Vector_Control_SVPWM_encoderless_learn_autoinheritance_info(nlhs,
      plhs,3,newRhs);
  }
...
{
  extern unsigned int
    sf_Vector_Control_SVPWM_encoderless_learn_get_eml_resolved_functions_info
...
extern unsigned int sf_Vector_Control_SVPWM_encoderless_learn_method_dispatcher
...
unsigned int sf_machine_global_method_dispatcher(SimStruct *simstructPtr, const
  ...
  method, void *data)
{
  if (!strcmp(machineName,"Vector_Control_SVPWM_encoderless_learn")) {
    return(sf_Vector_Control_SVPWM_encoderless_learn_method_dispatcher
...
extern void Vector_Control_SVPWM_encoderless_learn_terminator(void);
void sf_machine_global_terminator(void)
{
  if (sfMachineGlobalTerminatorCallable) {
    ...
    Vector_Control_SVPWM_encoderless_learn_terminator();
    sf_debug_terminate();
  }
...
extern void Vector_Control_SVPWM_encoderless_learn_initializer(void);
extern void Vector_Control_SVPWM_encoderless_learn_register_exported_symbols
  (SimStruct* S);
extern void Vector_Control_SVPWM_encoderless_learn_debug_initialize(void);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  Vector_Control_SVPWM_encoderless_learn_register_exported_symbols(S);
}
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfMachineGlobalInitializerCallable) {
    ...
    if (!simModeIsRTWGen) {
      Vector_Control_SVPWM_encoderless_learn_debug_initialize();
    }

    Vector_Control_SVPWM_encoderless_learn_initializer();
  }
