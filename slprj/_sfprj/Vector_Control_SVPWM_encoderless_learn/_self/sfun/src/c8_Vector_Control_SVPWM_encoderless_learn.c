...
static void initialize_c8_Vector_Control_SVPWM_encoderless_learn
  (SFc8_Vector_Control_SVPWM_encoderless_learnInstanceStruct *chartInstance);
static void initialize_params_c8_Vector_Control_SVPWM_encoderless_learn
  (SFc8_Vector_Control_SVPWM_encoderless_learnInstanceStruct *chartInstance);
static void enable_c8_Vector_Control_SVPWM_encoderless_learn
  (SFc8_Vector_Control_SVPWM_encoderless_learnInstanceStruct *chartInstance);
static void disable_c8_Vector_Control_SVPWM_encoderless_learn
  (SFc8_Vector_Control_SVPWM_encoderless_learnInstanceStruct *chartInstance);
static void c8_update_debugger_state_c8_Vector_Control_SVPWM_encoderless_lea
  (SFc8_Vector_Control_SVPWM_encoderless_learnInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c8_Vector_Control_SVPWM_encoderless_learn
  (SFc8_Vector_Control_SVPWM_encoderless_learnInstanceStruct *chartInstance);
static void set_sim_state_c8_Vector_Control_SVPWM_encoderless_learn
  (SFc8_Vector_Control_SVPWM_encoderless_learnInstanceStruct *chartInstance,
   const mxArray *c8_st);
static void finalize_c8_Vector_Control_SVPWM_encoderless_learn
  (SFc8_Vector_Control_SVPWM_encoderless_learnInstanceStruct *chartInstance);
static void sf_c8_Vector_Control_SVPWM_encoderless_learn
  (SFc8_Vector_Control_SVPWM_encoderless_learnInstanceStruct *chartInstance);
static void initSimStructsc8_Vector_Control_SVPWM_encoderless_learn
  (SFc8_Vector_Control_SVPWM_encoderless_learnInstanceStruct *chartInstance);
...
static real_T c8_emlrt_marshallIn
  (SFc8_Vector_Control_SVPWM_encoderless_learnInstanceStruct *chartInstance,
   const mxArray *c8_Vbeta, const char_T *c8_identifier);
...
static uint8_T c8_d_emlrt_marshallIn
  (SFc8_Vector_Control_SVPWM_encoderless_learnInstanceStruct *chartInstance,
   const mxArray *c8_b_is_active_c8_Vector_Control_SVPWM_encoderless_learn,
  ...
  (SFc8_Vector_Control_SVPWM_encoderless_learnInstanceStruct *chartInstance)
{
  ...
  chartInstance->c8_is_active_c8_Vector_Control_SVPWM_encoderless_learn = 0U;
}
  ...
  (SFc8_Vector_Control_SVPWM_encoderless_learnInstanceStruct *chartInstance)
{
  ...
  c8_c_hoistedGlobal =
    chartInstance->c8_is_active_c8_Vector_Control_SVPWM_encoderless_learn;
   ...
   const mxArray *c8_st)
{
  ...
  *c8_Vbeta = c8_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c8_u,
    1)), "Vbeta");
  chartInstance->c8_is_active_c8_Vector_Control_SVPWM_encoderless_learn =
    c8_d_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c8_u, 2)),
    "is_active_c8_Vector_Control_SVPWM_encoderless_learn");
  sf_mex_destroy(&c8_u);
  c8_update_debugger_state_c8_Vector_Control_SVPWM_encoderless_lea(chartInstance);
...
static const mxArray *c8_sf_marshallOut(void *chartInstanceVoid, void *c8_inData)
{
  ...
  const mxArray *c8_y = NULL;
  SFc8_Vector_Control_SVPWM_encoderless_learnInstanceStruct *chartInstance;
  chartInstance = (SFc8_Vector_Control_SVPWM_encoderless_learnInstanceStruct *)
    chartInstanceVoid;
   ...
   const char_T *c8_identifier)
{
  ...
  c8_y = c8_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c8_b_is_active_c8_Vector_Control_SVPWM_encoderless_learn), &c8_thisId);
  sf_mex_destroy(&c8_b_is_active_c8_Vector_Control_SVPWM_encoderless_learn);
  return c8_y;
}
...
/* SFunction Glue Code */
void sf_c8_Vector_Control_SVPWM_encoderless_learn_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c8_Vector_Control_SVPWM_encoderless_learn_get_autoinheritance_info
  (void)
{
...
static const mxArray
  *sf_get_sim_state_info_c8_Vector_Control_SVPWM_encoderless_learn(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[5],T\"Valpha\",},{M[1],M[8],T\"Vbeta\",},{M[8],M[0],T\"is_active_c8_Vector_Control_SVPWM_encoderless_learn\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c8_Vector_Control_SVPWM_encoderless_learn_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c8_Vector_Control_SVPWM_encoderless_learn(void *
  chartInstanceVar)
{
  chart_debug_initialization
    (((SFc8_Vector_Control_SVPWM_encoderless_learnInstanceStruct*)
      chartInstanceVar)->S,0);
  initialize_params_c8_Vector_Control_SVPWM_encoderless_learn
    ((SFc8_Vector_Control_SVPWM_encoderless_learnInstanceStruct*)
     chartInstanceVar);
  initialize_c8_Vector_Control_SVPWM_encoderless_learn
    ((SFc8_Vector_Control_SVPWM_encoderless_learnInstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_enable_c8_Vector_Control_SVPWM_encoderless_learn(void
  *chartInstanceVar)
{
  enable_c8_Vector_Control_SVPWM_encoderless_learn
    ((SFc8_Vector_Control_SVPWM_encoderless_learnInstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_disable_c8_Vector_Control_SVPWM_encoderless_learn(void
  *chartInstanceVar)
{
  disable_c8_Vector_Control_SVPWM_encoderless_learn
    ((SFc8_Vector_Control_SVPWM_encoderless_learnInstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_gateway_c8_Vector_Control_SVPWM_encoderless_learn(void
  *chartInstanceVar)
{
  sf_c8_Vector_Control_SVPWM_encoderless_learn
    ((SFc8_Vector_Control_SVPWM_encoderless_learnInstanceStruct*)
     chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c8_Vector_Control_SVPWM_encoderless_learn(SimStruct*
  S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c8_Vector_Control_SVPWM_encoderless_learn
    ((SFc8_Vector_Control_SVPWM_encoderless_learnInstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
  prhs[3] = (mxArray*)
    sf_get_sim_state_info_c8_Vector_Control_SVPWM_encoderless_learn();/* state var info */
...
extern void sf_internal_set_sim_state_c8_Vector_Control_SVPWM_encoderless_learn
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c8_Vector_Control_SVPWM_encoderless_learn
    ((SFc8_Vector_Control_SVPWM_encoderless_learnInstanceStruct*)
...
static const mxArray*
  sf_opaque_get_sim_state_c8_Vector_Control_SVPWM_encoderless_learn(SimStruct* S)
{
  return sf_internal_get_sim_state_c8_Vector_Control_SVPWM_encoderless_learn(S);
}

static void sf_opaque_set_sim_state_c8_Vector_Control_SVPWM_encoderless_learn
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c8_Vector_Control_SVPWM_encoderless_learn(S, st);
}

static void sf_opaque_terminate_c8_Vector_Control_SVPWM_encoderless_learn(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc8_Vector_Control_SVPWM_encoderless_learnInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c8_Vector_Control_SVPWM_encoderless_learn
      ((SFc8_Vector_Control_SVPWM_encoderless_learnInstanceStruct*)
       chartInstanceVar);
...
{
  initSimStructsc8_Vector_Control_SVPWM_encoderless_learn
    ((SFc8_Vector_Control_SVPWM_encoderless_learnInstanceStruct*)
     chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c8_Vector_Control_SVPWM_encoderless_learn
  (SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c8_Vector_Control_SVPWM_encoderless_learn(SimStruct
  *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct =
...
static void mdlRTW_c8_Vector_Control_SVPWM_encoderless_learn(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c8_Vector_Control_SVPWM_encoderless_learn(SimStruct *S)
{
  SFc8_Vector_Control_SVPWM_encoderless_learnInstanceStruct *chartInstance;
  chartInstance = (SFc8_Vector_Control_SVPWM_encoderless_learnInstanceStruct *)
    malloc(sizeof(SFc8_Vector_Control_SVPWM_encoderless_learnInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c8_Vector_Control_SVPWM_encoderless_learn;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c8_Vector_Control_SVPWM_encoderless_learn;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c8_Vector_Control_SVPWM_encoderless_learn;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c8_Vector_Control_SVPWM_encoderless_learn;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c8_Vector_Control_SVPWM_encoderless_learn;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c8_Vector_Control_SVPWM_encoderless_learn;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c8_Vector_Control_SVPWM_encoderless_learn;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c8_Vector_Control_SVPWM_encoderless_learn;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW =
    mdlRTW_c8_Vector_Control_SVPWM_encoderless_learn;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c8_Vector_Control_SVPWM_encoderless_learn;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c8_Vector_Control_SVPWM_encoderless_learn;
...
void c8_Vector_Control_SVPWM_encoderless_learn_method_dispatcher(SimStruct *S,
  int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c8_Vector_Control_SVPWM_encoderless_learn(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c8_Vector_Control_SVPWM_encoderless_learn(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c8_Vector_Control_SVPWM_encoderless_learn(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c8_Vector_Control_SVPWM_encoderless_learn_method_dispatcher.\n"
