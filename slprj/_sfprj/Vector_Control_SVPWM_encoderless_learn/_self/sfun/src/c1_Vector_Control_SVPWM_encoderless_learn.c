...
static void initialize_c1_Vector_Control_SVPWM_encoderless_learn
  (SFc1_Vector_Control_SVPWM_encoderless_learnInstanceStruct *chartInstance);
static void initialize_params_c1_Vector_Control_SVPWM_encoderless_learn
  (SFc1_Vector_Control_SVPWM_encoderless_learnInstanceStruct *chartInstance);
static void enable_c1_Vector_Control_SVPWM_encoderless_learn
  (SFc1_Vector_Control_SVPWM_encoderless_learnInstanceStruct *chartInstance);
static void disable_c1_Vector_Control_SVPWM_encoderless_learn
  (SFc1_Vector_Control_SVPWM_encoderless_learnInstanceStruct *chartInstance);
static void c1_update_debugger_state_c1_Vector_Control_SVPWM_encoderless_lea
  (SFc1_Vector_Control_SVPWM_encoderless_learnInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c1_Vector_Control_SVPWM_encoderless_learn
  (SFc1_Vector_Control_SVPWM_encoderless_learnInstanceStruct *chartInstance);
static void set_sim_state_c1_Vector_Control_SVPWM_encoderless_learn
  (SFc1_Vector_Control_SVPWM_encoderless_learnInstanceStruct *chartInstance,
   const mxArray *c1_st);
static void finalize_c1_Vector_Control_SVPWM_encoderless_learn
  (SFc1_Vector_Control_SVPWM_encoderless_learnInstanceStruct *chartInstance);
static void sf_c1_Vector_Control_SVPWM_encoderless_learn
  (SFc1_Vector_Control_SVPWM_encoderless_learnInstanceStruct *chartInstance);
static void initSimStructsc1_Vector_Control_SVPWM_encoderless_learn
  (SFc1_Vector_Control_SVPWM_encoderless_learnInstanceStruct *chartInstance);
...
static real_T c1_emlrt_marshallIn
  (SFc1_Vector_Control_SVPWM_encoderless_learnInstanceStruct *chartInstance,
   const mxArray *c1_Sn, const char_T *c1_identifier);
...
static uint8_T c1_d_emlrt_marshallIn
  (SFc1_Vector_Control_SVPWM_encoderless_learnInstanceStruct *chartInstance,
   const mxArray *c1_b_is_active_c1_Vector_Control_SVPWM_encoderless_learn,
  ...
  (SFc1_Vector_Control_SVPWM_encoderless_learnInstanceStruct *chartInstance)
{
  ...
  chartInstance->c1_is_active_c1_Vector_Control_SVPWM_encoderless_learn = 0U;
}
  ...
  (SFc1_Vector_Control_SVPWM_encoderless_learnInstanceStruct *chartInstance)
{
  ...
  c1_b_hoistedGlobal =
    chartInstance->c1_is_active_c1_Vector_Control_SVPWM_encoderless_learn;
   ...
   const mxArray *c1_st)
{
  ...
  *c1_Sn = c1_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 0)),
  ...
  chartInstance->c1_is_active_c1_Vector_Control_SVPWM_encoderless_learn =
    ...
    "is_active_c1_Vector_Control_SVPWM_encoderless_learn");
  sf_mex_destroy(&c1_u);
  c1_update_debugger_state_c1_Vector_Control_SVPWM_encoderless_lea(chartInstance);
...
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData)
{
  ...
  const mxArray *c1_y = NULL;
  SFc1_Vector_Control_SVPWM_encoderless_learnInstanceStruct *chartInstance;
  chartInstance = (SFc1_Vector_Control_SVPWM_encoderless_learnInstanceStruct *)
    chartInstanceVoid;
   ...
   const char_T *c1_identifier)
{
  ...
  c1_y = c1_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c1_b_is_active_c1_Vector_Control_SVPWM_encoderless_learn), &c1_thisId);
  sf_mex_destroy(&c1_b_is_active_c1_Vector_Control_SVPWM_encoderless_learn);
  return c1_y;
}
...
/* SFunction Glue Code */
void sf_c1_Vector_Control_SVPWM_encoderless_learn_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c1_Vector_Control_SVPWM_encoderless_learn_get_autoinheritance_info
  (void)
{
...
static const mxArray
  *sf_get_sim_state_info_c1_Vector_Control_SVPWM_encoderless_learn(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[4],T\"Sn\",},{M[8],M[0],T\"is_active_c1_Vector_Control_SVPWM_encoderless_learn\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c1_Vector_Control_SVPWM_encoderless_learn_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c1_Vector_Control_SVPWM_encoderless_learn(void *
  chartInstanceVar)
{
  chart_debug_initialization
    (((SFc1_Vector_Control_SVPWM_encoderless_learnInstanceStruct*)
      chartInstanceVar)->S,0);
  initialize_params_c1_Vector_Control_SVPWM_encoderless_learn
    ((SFc1_Vector_Control_SVPWM_encoderless_learnInstanceStruct*)
     chartInstanceVar);
  initialize_c1_Vector_Control_SVPWM_encoderless_learn
    ((SFc1_Vector_Control_SVPWM_encoderless_learnInstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_enable_c1_Vector_Control_SVPWM_encoderless_learn(void
  *chartInstanceVar)
{
  enable_c1_Vector_Control_SVPWM_encoderless_learn
    ((SFc1_Vector_Control_SVPWM_encoderless_learnInstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_disable_c1_Vector_Control_SVPWM_encoderless_learn(void
  *chartInstanceVar)
{
  disable_c1_Vector_Control_SVPWM_encoderless_learn
    ((SFc1_Vector_Control_SVPWM_encoderless_learnInstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_gateway_c1_Vector_Control_SVPWM_encoderless_learn(void
  *chartInstanceVar)
{
  sf_c1_Vector_Control_SVPWM_encoderless_learn
    ((SFc1_Vector_Control_SVPWM_encoderless_learnInstanceStruct*)
     chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c1_Vector_Control_SVPWM_encoderless_learn(SimStruct*
  S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c1_Vector_Control_SVPWM_encoderless_learn
    ((SFc1_Vector_Control_SVPWM_encoderless_learnInstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
  prhs[3] = (mxArray*)
    sf_get_sim_state_info_c1_Vector_Control_SVPWM_encoderless_learn();/* state var info */
...
extern void sf_internal_set_sim_state_c1_Vector_Control_SVPWM_encoderless_learn
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c1_Vector_Control_SVPWM_encoderless_learn
    ((SFc1_Vector_Control_SVPWM_encoderless_learnInstanceStruct*)
...
static const mxArray*
  sf_opaque_get_sim_state_c1_Vector_Control_SVPWM_encoderless_learn(SimStruct* S)
{
  return sf_internal_get_sim_state_c1_Vector_Control_SVPWM_encoderless_learn(S);
}

static void sf_opaque_set_sim_state_c1_Vector_Control_SVPWM_encoderless_learn
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c1_Vector_Control_SVPWM_encoderless_learn(S, st);
}

static void sf_opaque_terminate_c1_Vector_Control_SVPWM_encoderless_learn(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_Vector_Control_SVPWM_encoderless_learnInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c1_Vector_Control_SVPWM_encoderless_learn
      ((SFc1_Vector_Control_SVPWM_encoderless_learnInstanceStruct*)
       chartInstanceVar);
...
{
  initSimStructsc1_Vector_Control_SVPWM_encoderless_learn
    ((SFc1_Vector_Control_SVPWM_encoderless_learnInstanceStruct*)
     chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_Vector_Control_SVPWM_encoderless_learn
  (SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c1_Vector_Control_SVPWM_encoderless_learn(SimStruct
  *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct =
...
static void mdlRTW_c1_Vector_Control_SVPWM_encoderless_learn(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c1_Vector_Control_SVPWM_encoderless_learn(SimStruct *S)
{
  SFc1_Vector_Control_SVPWM_encoderless_learnInstanceStruct *chartInstance;
  chartInstance = (SFc1_Vector_Control_SVPWM_encoderless_learnInstanceStruct *)
    malloc(sizeof(SFc1_Vector_Control_SVPWM_encoderless_learnInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c1_Vector_Control_SVPWM_encoderless_learn;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c1_Vector_Control_SVPWM_encoderless_learn;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c1_Vector_Control_SVPWM_encoderless_learn;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c1_Vector_Control_SVPWM_encoderless_learn;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c1_Vector_Control_SVPWM_encoderless_learn;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c1_Vector_Control_SVPWM_encoderless_learn;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c1_Vector_Control_SVPWM_encoderless_learn;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c1_Vector_Control_SVPWM_encoderless_learn;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW =
    mdlRTW_c1_Vector_Control_SVPWM_encoderless_learn;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c1_Vector_Control_SVPWM_encoderless_learn;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c1_Vector_Control_SVPWM_encoderless_learn;
...
void c1_Vector_Control_SVPWM_encoderless_learn_method_dispatcher(SimStruct *S,
  int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c1_Vector_Control_SVPWM_encoderless_learn(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_Vector_Control_SVPWM_encoderless_learn(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_Vector_Control_SVPWM_encoderless_learn(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_Vector_Control_SVPWM_encoderless_learn_method_dispatcher.\n"
