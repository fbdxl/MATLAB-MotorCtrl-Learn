...
#include "c13_VectorCtrl_Asynchronous_debugSPWM.h"
...
static void initialize_c13_VectorCtrl_Asynchronous_debugSPWM
  (SFc13_VectorCtrl_Asynchronous_debugSPWMInstanceStruct *chartInstance);
static void initialize_params_c13_VectorCtrl_Asynchronous_debugSPWM
  (SFc13_VectorCtrl_Asynchronous_debugSPWMInstanceStruct *chartInstance);
static void enable_c13_VectorCtrl_Asynchronous_debugSPWM
  (SFc13_VectorCtrl_Asynchronous_debugSPWMInstanceStruct *chartInstance);
static void disable_c13_VectorCtrl_Asynchronous_debugSPWM
  (SFc13_VectorCtrl_Asynchronous_debugSPWMInstanceStruct *chartInstance);
static void c13_update_debugger_state_c13_VectorCtrl_Asynchronous_debugSPWM
  (SFc13_VectorCtrl_Asynchronous_debugSPWMInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c13_VectorCtrl_Asynchronous_debugSPWM
  (SFc13_VectorCtrl_Asynchronous_debugSPWMInstanceStruct *chartInstance);
static void set_sim_state_c13_VectorCtrl_Asynchronous_debugSPWM
  (SFc13_VectorCtrl_Asynchronous_debugSPWMInstanceStruct *chartInstance, const
   mxArray *c13_st);
static void finalize_c13_VectorCtrl_Asynchronous_debugSPWM
  (SFc13_VectorCtrl_Asynchronous_debugSPWMInstanceStruct *chartInstance);
static void sf_c13_VectorCtrl_Asynchronous_debugSPWM
  (SFc13_VectorCtrl_Asynchronous_debugSPWMInstanceStruct *chartInstance);
static void initSimStructsc13_VectorCtrl_Asynchronous_debugSPWM
  (SFc13_VectorCtrl_Asynchronous_debugSPWMInstanceStruct *chartInstance);
...
static real_T c13_emlrt_marshallIn
  (SFc13_VectorCtrl_Asynchronous_debugSPWMInstanceStruct *chartInstance, const
   mxArray *c13_Vc, const char_T *c13_identifier);
...
static uint8_T c13_d_emlrt_marshallIn
  (SFc13_VectorCtrl_Asynchronous_debugSPWMInstanceStruct *chartInstance, const
   mxArray *c13_b_is_active_c13_VectorCtrl_Asynchronous_debugSPWM, const char_T *
   c13_identifier);
  ...
  (SFc13_VectorCtrl_Asynchronous_debugSPWMInstanceStruct *chartInstance)
{
  ...
  chartInstance->c13_is_active_c13_VectorCtrl_Asynchronous_debugSPWM = 0U;
}
  ...
  (SFc13_VectorCtrl_Asynchronous_debugSPWMInstanceStruct *chartInstance)
{
  ...
  c13_d_hoistedGlobal =
    chartInstance->c13_is_active_c13_VectorCtrl_Asynchronous_debugSPWM;
   ...
   mxArray *c13_st)
{
  ...
  *c13_Vc = c13_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c13_u,
  ...
  chartInstance->c13_is_active_c13_VectorCtrl_Asynchronous_debugSPWM =
    ...
    "is_active_c13_VectorCtrl_Asynchronous_debugSPWM");
  sf_mex_destroy(&c13_u);
  c13_update_debugger_state_c13_VectorCtrl_Asynchronous_debugSPWM(chartInstance);
  ...
  *c13_inData)
{
  ...
  const mxArray *c13_y = NULL;
  SFc13_VectorCtrl_Asynchronous_debugSPWMInstanceStruct *chartInstance;
  chartInstance = (SFc13_VectorCtrl_Asynchronous_debugSPWMInstanceStruct *)
    chartInstanceVoid;
...
const mxArray
  *sf_c13_VectorCtrl_Asynchronous_debugSPWM_get_eml_resolved_functions_info(void)
{
   ...
   c13_identifier)
{
  ...
  c13_y = c13_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c13_b_is_active_c13_VectorCtrl_Asynchronous_debugSPWM), &c13_thisId);
  sf_mex_destroy(&c13_b_is_active_c13_VectorCtrl_Asynchronous_debugSPWM);
  return c13_y;
}
...
/* SFunction Glue Code */
void sf_c13_VectorCtrl_Asynchronous_debugSPWM_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c13_VectorCtrl_Asynchronous_debugSPWM_get_autoinheritance_info(void)
{
...
static const mxArray
  *sf_get_sim_state_info_c13_VectorCtrl_Asynchronous_debugSPWM(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x4'type','srcId','name','auxInfo'{{M[1],M[4],T\"Va\",},{M[1],M[6],T\"Vb\",},{M[1],M[7],T\"Vc\",},{M[8],M[0],T\"is_active_c13_VectorCtrl_Asynchronous_debugSPWM\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 4, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c13_VectorCtrl_Asynchronous_debugSPWM_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c13_VectorCtrl_Asynchronous_debugSPWM(void
  *chartInstanceVar)
{
  chart_debug_initialization
    (((SFc13_VectorCtrl_Asynchronous_debugSPWMInstanceStruct*) chartInstanceVar
     )->S,0);
  initialize_params_c13_VectorCtrl_Asynchronous_debugSPWM
    ((SFc13_VectorCtrl_Asynchronous_debugSPWMInstanceStruct*) chartInstanceVar);
  initialize_c13_VectorCtrl_Asynchronous_debugSPWM
    ((SFc13_VectorCtrl_Asynchronous_debugSPWMInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c13_VectorCtrl_Asynchronous_debugSPWM(void
  *chartInstanceVar)
{
  enable_c13_VectorCtrl_Asynchronous_debugSPWM
    ((SFc13_VectorCtrl_Asynchronous_debugSPWMInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c13_VectorCtrl_Asynchronous_debugSPWM(void
  *chartInstanceVar)
{
  disable_c13_VectorCtrl_Asynchronous_debugSPWM
    ((SFc13_VectorCtrl_Asynchronous_debugSPWMInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c13_VectorCtrl_Asynchronous_debugSPWM(void
  *chartInstanceVar)
{
  sf_c13_VectorCtrl_Asynchronous_debugSPWM
    ((SFc13_VectorCtrl_Asynchronous_debugSPWMInstanceStruct*) chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c13_VectorCtrl_Asynchronous_debugSPWM(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c13_VectorCtrl_Asynchronous_debugSPWM
    ((SFc13_VectorCtrl_Asynchronous_debugSPWMInstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
  prhs[3] = (mxArray*)
    sf_get_sim_state_info_c13_VectorCtrl_Asynchronous_debugSPWM();/* state var info */
...
extern void sf_internal_set_sim_state_c13_VectorCtrl_Asynchronous_debugSPWM
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c13_VectorCtrl_Asynchronous_debugSPWM
    ((SFc13_VectorCtrl_Asynchronous_debugSPWMInstanceStruct*)
...
static const mxArray*
  sf_opaque_get_sim_state_c13_VectorCtrl_Asynchronous_debugSPWM(SimStruct* S)
{
  return sf_internal_get_sim_state_c13_VectorCtrl_Asynchronous_debugSPWM(S);
}

static void sf_opaque_set_sim_state_c13_VectorCtrl_Asynchronous_debugSPWM
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c13_VectorCtrl_Asynchronous_debugSPWM(S, st);
}

static void sf_opaque_terminate_c13_VectorCtrl_Asynchronous_debugSPWM(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc13_VectorCtrl_Asynchronous_debugSPWMInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c13_VectorCtrl_Asynchronous_debugSPWM
      ((SFc13_VectorCtrl_Asynchronous_debugSPWMInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc13_VectorCtrl_Asynchronous_debugSPWM
    ((SFc13_VectorCtrl_Asynchronous_debugSPWMInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c13_VectorCtrl_Asynchronous_debugSPWM(SimStruct
  *S)
{
  int i;
...
static void mdlSetWorkWidths_c13_VectorCtrl_Asynchronous_debugSPWM(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct =
...
static void mdlRTW_c13_VectorCtrl_Asynchronous_debugSPWM(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c13_VectorCtrl_Asynchronous_debugSPWM(SimStruct *S)
{
  SFc13_VectorCtrl_Asynchronous_debugSPWMInstanceStruct *chartInstance;
  chartInstance = (SFc13_VectorCtrl_Asynchronous_debugSPWMInstanceStruct *)
    malloc(sizeof(SFc13_VectorCtrl_Asynchronous_debugSPWMInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c13_VectorCtrl_Asynchronous_debugSPWM;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c13_VectorCtrl_Asynchronous_debugSPWM;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c13_VectorCtrl_Asynchronous_debugSPWM;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c13_VectorCtrl_Asynchronous_debugSPWM;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c13_VectorCtrl_Asynchronous_debugSPWM;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c13_VectorCtrl_Asynchronous_debugSPWM;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c13_VectorCtrl_Asynchronous_debugSPWM;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c13_VectorCtrl_Asynchronous_debugSPWM;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c13_VectorCtrl_Asynchronous_debugSPWM;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c13_VectorCtrl_Asynchronous_debugSPWM;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c13_VectorCtrl_Asynchronous_debugSPWM;
...
void c13_VectorCtrl_Asynchronous_debugSPWM_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c13_VectorCtrl_Asynchronous_debugSPWM(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c13_VectorCtrl_Asynchronous_debugSPWM(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c13_VectorCtrl_Asynchronous_debugSPWM(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c13_VectorCtrl_Asynchronous_debugSPWM_method_dispatcher.\n"
