...
static void initialize_c1_VectorCtrl_Asynchronous_debugSPWM
  (SFc1_VectorCtrl_Asynchronous_debugSPWMInstanceStruct *chartInstance);
static void initialize_params_c1_VectorCtrl_Asynchronous_debugSPWM
  (SFc1_VectorCtrl_Asynchronous_debugSPWMInstanceStruct *chartInstance);
static void enable_c1_VectorCtrl_Asynchronous_debugSPWM
  (SFc1_VectorCtrl_Asynchronous_debugSPWMInstanceStruct *chartInstance);
static void disable_c1_VectorCtrl_Asynchronous_debugSPWM
  (SFc1_VectorCtrl_Asynchronous_debugSPWMInstanceStruct *chartInstance);
static void c1_update_debugger_state_c1_VectorCtrl_Asynchronous_debugSPWM
  (SFc1_VectorCtrl_Asynchronous_debugSPWMInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c1_VectorCtrl_Asynchronous_debugSPWM
  (SFc1_VectorCtrl_Asynchronous_debugSPWMInstanceStruct *chartInstance);
static void set_sim_state_c1_VectorCtrl_Asynchronous_debugSPWM
  (SFc1_VectorCtrl_Asynchronous_debugSPWMInstanceStruct *chartInstance, const
   mxArray *c1_st);
static void finalize_c1_VectorCtrl_Asynchronous_debugSPWM
  (SFc1_VectorCtrl_Asynchronous_debugSPWMInstanceStruct *chartInstance);
static void sf_c1_VectorCtrl_Asynchronous_debugSPWM
  (SFc1_VectorCtrl_Asynchronous_debugSPWMInstanceStruct *chartInstance);
static void initSimStructsc1_VectorCtrl_Asynchronous_debugSPWM
  (SFc1_VectorCtrl_Asynchronous_debugSPWMInstanceStruct *chartInstance);
...
static real_T c1_emlrt_marshallIn
  (SFc1_VectorCtrl_Asynchronous_debugSPWMInstanceStruct *chartInstance, const
   mxArray *c1_ValueAfterRamp, const char_T *c1_identifier);
...
static uint8_T c1_d_emlrt_marshallIn
  (SFc1_VectorCtrl_Asynchronous_debugSPWMInstanceStruct *chartInstance, const
   mxArray *c1_b_is_active_c1_VectorCtrl_Asynchronous_debugSPWM, const char_T
   *c1_identifier);
  ...
  (SFc1_VectorCtrl_Asynchronous_debugSPWMInstanceStruct *chartInstance)
{
  ...
  chartInstance->c1_is_active_c1_VectorCtrl_Asynchronous_debugSPWM = 0U;
}
  ...
  (SFc1_VectorCtrl_Asynchronous_debugSPWMInstanceStruct *chartInstance)
{
  ...
  c1_b_hoistedGlobal =
    chartInstance->c1_is_active_c1_VectorCtrl_Asynchronous_debugSPWM;
   ...
   mxArray *c1_st)
{
  ...
  *c1_ValueAfterRamp = c1_emlrt_marshallIn(chartInstance, sf_mex_dup
  ...
  chartInstance->c1_is_active_c1_VectorCtrl_Asynchronous_debugSPWM =
    ...
    "is_active_c1_VectorCtrl_Asynchronous_debugSPWM");
  sf_mex_destroy(&c1_u);
  c1_update_debugger_state_c1_VectorCtrl_Asynchronous_debugSPWM(chartInstance);
...
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData)
{
  ...
  const mxArray *c1_y = NULL;
  SFc1_VectorCtrl_Asynchronous_debugSPWMInstanceStruct *chartInstance;
  chartInstance = (SFc1_VectorCtrl_Asynchronous_debugSPWMInstanceStruct *)
    chartInstanceVoid;
...
const mxArray
  *sf_c1_VectorCtrl_Asynchronous_debugSPWM_get_eml_resolved_functions_info(void)
{
   ...
   *c1_identifier)
{
  ...
  c1_y = c1_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c1_b_is_active_c1_VectorCtrl_Asynchronous_debugSPWM), &c1_thisId);
  sf_mex_destroy(&c1_b_is_active_c1_VectorCtrl_Asynchronous_debugSPWM);
  return c1_y;
}
...
/* SFunction Glue Code */
void sf_c1_VectorCtrl_Asynchronous_debugSPWM_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c1_VectorCtrl_Asynchronous_debugSPWM_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c1_VectorCtrl_Asynchronous_debugSPWM
  (void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"ValueAfterRamp\",},{M[8],M[0],T\"is_active_c1_VectorCtrl_Asynchronous_debugSPWM\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c1_VectorCtrl_Asynchronous_debugSPWM_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c1_VectorCtrl_Asynchronous_debugSPWM(void
  *chartInstanceVar)
{
  chart_debug_initialization
    (((SFc1_VectorCtrl_Asynchronous_debugSPWMInstanceStruct*) chartInstanceVar
     )->S,0);
  initialize_params_c1_VectorCtrl_Asynchronous_debugSPWM
    ((SFc1_VectorCtrl_Asynchronous_debugSPWMInstanceStruct*) chartInstanceVar);
  initialize_c1_VectorCtrl_Asynchronous_debugSPWM
    ((SFc1_VectorCtrl_Asynchronous_debugSPWMInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c1_VectorCtrl_Asynchronous_debugSPWM(void
  *chartInstanceVar)
{
  enable_c1_VectorCtrl_Asynchronous_debugSPWM
    ((SFc1_VectorCtrl_Asynchronous_debugSPWMInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c1_VectorCtrl_Asynchronous_debugSPWM(void
  *chartInstanceVar)
{
  disable_c1_VectorCtrl_Asynchronous_debugSPWM
    ((SFc1_VectorCtrl_Asynchronous_debugSPWMInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c1_VectorCtrl_Asynchronous_debugSPWM(void
  *chartInstanceVar)
{
  sf_c1_VectorCtrl_Asynchronous_debugSPWM
    ((SFc1_VectorCtrl_Asynchronous_debugSPWMInstanceStruct*) chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c1_VectorCtrl_Asynchronous_debugSPWM(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c1_VectorCtrl_Asynchronous_debugSPWM
    ((SFc1_VectorCtrl_Asynchronous_debugSPWMInstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
  prhs[3] = (mxArray*)
    sf_get_sim_state_info_c1_VectorCtrl_Asynchronous_debugSPWM();/* state var info */
...
extern void sf_internal_set_sim_state_c1_VectorCtrl_Asynchronous_debugSPWM
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c1_VectorCtrl_Asynchronous_debugSPWM
    ((SFc1_VectorCtrl_Asynchronous_debugSPWMInstanceStruct*)
...
static const mxArray*
  sf_opaque_get_sim_state_c1_VectorCtrl_Asynchronous_debugSPWM(SimStruct* S)
{
  return sf_internal_get_sim_state_c1_VectorCtrl_Asynchronous_debugSPWM(S);
}

static void sf_opaque_set_sim_state_c1_VectorCtrl_Asynchronous_debugSPWM
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c1_VectorCtrl_Asynchronous_debugSPWM(S, st);
}

static void sf_opaque_terminate_c1_VectorCtrl_Asynchronous_debugSPWM(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_VectorCtrl_Asynchronous_debugSPWMInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c1_VectorCtrl_Asynchronous_debugSPWM
      ((SFc1_VectorCtrl_Asynchronous_debugSPWMInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc1_VectorCtrl_Asynchronous_debugSPWM
    ((SFc1_VectorCtrl_Asynchronous_debugSPWMInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_VectorCtrl_Asynchronous_debugSPWM(SimStruct *
  S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c1_VectorCtrl_Asynchronous_debugSPWM
      ((SFc1_VectorCtrl_Asynchronous_debugSPWMInstanceStruct*)(((ChartInfoStruct
          *)ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c1_VectorCtrl_Asynchronous_debugSPWM(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct =
...
static void mdlRTW_c1_VectorCtrl_Asynchronous_debugSPWM(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c1_VectorCtrl_Asynchronous_debugSPWM(SimStruct *S)
{
  SFc1_VectorCtrl_Asynchronous_debugSPWMInstanceStruct *chartInstance;
  chartInstance = (SFc1_VectorCtrl_Asynchronous_debugSPWMInstanceStruct *)malloc
    (sizeof(SFc1_VectorCtrl_Asynchronous_debugSPWMInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c1_VectorCtrl_Asynchronous_debugSPWM;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c1_VectorCtrl_Asynchronous_debugSPWM;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c1_VectorCtrl_Asynchronous_debugSPWM;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c1_VectorCtrl_Asynchronous_debugSPWM;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c1_VectorCtrl_Asynchronous_debugSPWM;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c1_VectorCtrl_Asynchronous_debugSPWM;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c1_VectorCtrl_Asynchronous_debugSPWM;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c1_VectorCtrl_Asynchronous_debugSPWM;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c1_VectorCtrl_Asynchronous_debugSPWM;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c1_VectorCtrl_Asynchronous_debugSPWM;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c1_VectorCtrl_Asynchronous_debugSPWM;
...
void c1_VectorCtrl_Asynchronous_debugSPWM_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c1_VectorCtrl_Asynchronous_debugSPWM(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_VectorCtrl_Asynchronous_debugSPWM(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_VectorCtrl_Asynchronous_debugSPWM(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_VectorCtrl_Asynchronous_debugSPWM_method_dispatcher.\n"
