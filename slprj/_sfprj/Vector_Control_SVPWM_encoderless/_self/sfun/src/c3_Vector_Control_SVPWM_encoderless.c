...
#include "c3_Vector_Control_SVPWM_encoderless.h"
...
static void initialize_c3_Vector_Control_SVPWM_encoderless
  (SFc3_Vector_Control_SVPWM_encoderlessInstanceStruct *chartInstance);
static void initialize_params_c3_Vector_Control_SVPWM_encoderless
  (SFc3_Vector_Control_SVPWM_encoderlessInstanceStruct *chartInstance);
static void enable_c3_Vector_Control_SVPWM_encoderless
  (SFc3_Vector_Control_SVPWM_encoderlessInstanceStruct *chartInstance);
static void disable_c3_Vector_Control_SVPWM_encoderless
  (SFc3_Vector_Control_SVPWM_encoderlessInstanceStruct *chartInstance);
static void c3_update_debugger_state_c3_Vector_Control_SVPWM_encoderless
  (SFc3_Vector_Control_SVPWM_encoderlessInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c3_Vector_Control_SVPWM_encoderless
  (SFc3_Vector_Control_SVPWM_encoderlessInstanceStruct *chartInstance);
static void set_sim_state_c3_Vector_Control_SVPWM_encoderless
  (SFc3_Vector_Control_SVPWM_encoderlessInstanceStruct *chartInstance, const
   mxArray *c3_st);
static void finalize_c3_Vector_Control_SVPWM_encoderless
  (SFc3_Vector_Control_SVPWM_encoderlessInstanceStruct *chartInstance);
static void sf_c3_Vector_Control_SVPWM_encoderless
  (SFc3_Vector_Control_SVPWM_encoderlessInstanceStruct *chartInstance);
static void c3_chartstep_c3_Vector_Control_SVPWM_encoderless
  (SFc3_Vector_Control_SVPWM_encoderlessInstanceStruct *chartInstance);
static void initSimStructsc3_Vector_Control_SVPWM_encoderless
  (SFc3_Vector_Control_SVPWM_encoderlessInstanceStruct *chartInstance);
...
static real_T c3_emlrt_marshallIn
  (SFc3_Vector_Control_SVPWM_encoderlessInstanceStruct *chartInstance, const
   mxArray *c3_T0, const char_T *c3_identifier);
...
static uint8_T c3_d_emlrt_marshallIn
  (SFc3_Vector_Control_SVPWM_encoderlessInstanceStruct *chartInstance, const
   mxArray *c3_b_is_active_c3_Vector_Control_SVPWM_encoderless, const char_T
   *c3_identifier);
  ...
  (SFc3_Vector_Control_SVPWM_encoderlessInstanceStruct *chartInstance)
{
  ...
  chartInstance->c3_is_active_c3_Vector_Control_SVPWM_encoderless = 0U;
}
  ...
  (SFc3_Vector_Control_SVPWM_encoderlessInstanceStruct *chartInstance)
{
  ...
  c3_d_hoistedGlobal =
    chartInstance->c3_is_active_c3_Vector_Control_SVPWM_encoderless;
   ...
   mxArray *c3_st)
{
  ...
  *c3_T2 = c3_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c3_u, 2)),
  ...
  chartInstance->c3_is_active_c3_Vector_Control_SVPWM_encoderless =
    ...
    "is_active_c3_Vector_Control_SVPWM_encoderless");
  sf_mex_destroy(&c3_u);
  c3_update_debugger_state_c3_Vector_Control_SVPWM_encoderless(chartInstance);
  ...
  (SFc3_Vector_Control_SVPWM_encoderlessInstanceStruct *chartInstance)
{
  ...
  chartInstance->c3_sfEvent = CALL_EVENT;
  c3_chartstep_c3_Vector_Control_SVPWM_encoderless(chartInstance);
...
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData)
{
  ...
  const mxArray *c3_y = NULL;
  SFc3_Vector_Control_SVPWM_encoderlessInstanceStruct *chartInstance;
  chartInstance = (SFc3_Vector_Control_SVPWM_encoderlessInstanceStruct *)
    chartInstanceVoid;
...
const mxArray
  *sf_c3_Vector_Control_SVPWM_encoderless_get_eml_resolved_functions_info(void)
{
   ...
   *c3_identifier)
{
  ...
  c3_y = c3_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c3_b_is_active_c3_Vector_Control_SVPWM_encoderless), &c3_thisId);
  sf_mex_destroy(&c3_b_is_active_c3_Vector_Control_SVPWM_encoderless);
  return c3_y;
}
...
/* SFunction Glue Code */
void sf_c3_Vector_Control_SVPWM_encoderless_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c3_Vector_Control_SVPWM_encoderless_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c3_Vector_Control_SVPWM_encoderless
  (void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x4'type','srcId','name','auxInfo'{{M[1],M[9],T\"T0\",},{M[1],M[7],T\"T1\",},{M[1],M[8],T\"T2\",},{M[8],M[0],T\"is_active_c3_Vector_Control_SVPWM_encoderless\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 4, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c3_Vector_Control_SVPWM_encoderless_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c3_Vector_Control_SVPWM_encoderless(void
  *chartInstanceVar)
{
  chart_debug_initialization
    (((SFc3_Vector_Control_SVPWM_encoderlessInstanceStruct*) chartInstanceVar)
     ->S,0);
  initialize_params_c3_Vector_Control_SVPWM_encoderless
    ((SFc3_Vector_Control_SVPWM_encoderlessInstanceStruct*) chartInstanceVar);
  initialize_c3_Vector_Control_SVPWM_encoderless
    ((SFc3_Vector_Control_SVPWM_encoderlessInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c3_Vector_Control_SVPWM_encoderless(void
  *chartInstanceVar)
{
  enable_c3_Vector_Control_SVPWM_encoderless
    ((SFc3_Vector_Control_SVPWM_encoderlessInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c3_Vector_Control_SVPWM_encoderless(void
  *chartInstanceVar)
{
  disable_c3_Vector_Control_SVPWM_encoderless
    ((SFc3_Vector_Control_SVPWM_encoderlessInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c3_Vector_Control_SVPWM_encoderless(void
  *chartInstanceVar)
{
  sf_c3_Vector_Control_SVPWM_encoderless
    ((SFc3_Vector_Control_SVPWM_encoderlessInstanceStruct*) chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c3_Vector_Control_SVPWM_encoderless(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c3_Vector_Control_SVPWM_encoderless
    ((SFc3_Vector_Control_SVPWM_encoderlessInstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c3_Vector_Control_SVPWM_encoderless
    ();                                /* state var info */
...
extern void sf_internal_set_sim_state_c3_Vector_Control_SVPWM_encoderless
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c3_Vector_Control_SVPWM_encoderless
    ((SFc3_Vector_Control_SVPWM_encoderlessInstanceStruct*)
...
static const mxArray*
  sf_opaque_get_sim_state_c3_Vector_Control_SVPWM_encoderless(SimStruct* S)
{
  return sf_internal_get_sim_state_c3_Vector_Control_SVPWM_encoderless(S);
}

static void sf_opaque_set_sim_state_c3_Vector_Control_SVPWM_encoderless
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c3_Vector_Control_SVPWM_encoderless(S, st);
}

static void sf_opaque_terminate_c3_Vector_Control_SVPWM_encoderless(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc3_Vector_Control_SVPWM_encoderlessInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c3_Vector_Control_SVPWM_encoderless
      ((SFc3_Vector_Control_SVPWM_encoderlessInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc3_Vector_Control_SVPWM_encoderless
    ((SFc3_Vector_Control_SVPWM_encoderlessInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c3_Vector_Control_SVPWM_encoderless(SimStruct
  *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c3_Vector_Control_SVPWM_encoderless
      ((SFc3_Vector_Control_SVPWM_encoderlessInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c3_Vector_Control_SVPWM_encoderless(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct =
...
static void mdlRTW_c3_Vector_Control_SVPWM_encoderless(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c3_Vector_Control_SVPWM_encoderless(SimStruct *S)
{
  SFc3_Vector_Control_SVPWM_encoderlessInstanceStruct *chartInstance;
  chartInstance = (SFc3_Vector_Control_SVPWM_encoderlessInstanceStruct *)malloc
    (sizeof(SFc3_Vector_Control_SVPWM_encoderlessInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c3_Vector_Control_SVPWM_encoderless;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c3_Vector_Control_SVPWM_encoderless;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c3_Vector_Control_SVPWM_encoderless;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c3_Vector_Control_SVPWM_encoderless;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c3_Vector_Control_SVPWM_encoderless;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c3_Vector_Control_SVPWM_encoderless;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c3_Vector_Control_SVPWM_encoderless;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c3_Vector_Control_SVPWM_encoderless;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c3_Vector_Control_SVPWM_encoderless;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c3_Vector_Control_SVPWM_encoderless;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c3_Vector_Control_SVPWM_encoderless;
...
void c3_Vector_Control_SVPWM_encoderless_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c3_Vector_Control_SVPWM_encoderless(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c3_Vector_Control_SVPWM_encoderless(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c3_Vector_Control_SVPWM_encoderless(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c3_Vector_Control_SVPWM_encoderless_method_dispatcher.\n"
