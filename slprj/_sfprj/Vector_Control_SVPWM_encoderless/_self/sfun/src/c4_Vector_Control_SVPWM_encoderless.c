...
#include "c4_Vector_Control_SVPWM_encoderless.h"
...
static void initialize_c4_Vector_Control_SVPWM_encoderless
  (SFc4_Vector_Control_SVPWM_encoderlessInstanceStruct *chartInstance);
static void initialize_params_c4_Vector_Control_SVPWM_encoderless
  (SFc4_Vector_Control_SVPWM_encoderlessInstanceStruct *chartInstance);
static void enable_c4_Vector_Control_SVPWM_encoderless
  (SFc4_Vector_Control_SVPWM_encoderlessInstanceStruct *chartInstance);
static void disable_c4_Vector_Control_SVPWM_encoderless
  (SFc4_Vector_Control_SVPWM_encoderlessInstanceStruct *chartInstance);
static void c4_update_debugger_state_c4_Vector_Control_SVPWM_encoderless
  (SFc4_Vector_Control_SVPWM_encoderlessInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c4_Vector_Control_SVPWM_encoderless
  (SFc4_Vector_Control_SVPWM_encoderlessInstanceStruct *chartInstance);
static void set_sim_state_c4_Vector_Control_SVPWM_encoderless
  (SFc4_Vector_Control_SVPWM_encoderlessInstanceStruct *chartInstance, const
   mxArray *c4_st);
static void finalize_c4_Vector_Control_SVPWM_encoderless
  (SFc4_Vector_Control_SVPWM_encoderlessInstanceStruct *chartInstance);
static void sf_c4_Vector_Control_SVPWM_encoderless
  (SFc4_Vector_Control_SVPWM_encoderlessInstanceStruct *chartInstance);
static void initSimStructsc4_Vector_Control_SVPWM_encoderless
  (SFc4_Vector_Control_SVPWM_encoderlessInstanceStruct *chartInstance);
...
static real_T c4_emlrt_marshallIn
  (SFc4_Vector_Control_SVPWM_encoderlessInstanceStruct *chartInstance, const
   mxArray *c4_Tcmc, const char_T *c4_identifier);
...
static uint8_T c4_d_emlrt_marshallIn
  (SFc4_Vector_Control_SVPWM_encoderlessInstanceStruct *chartInstance, const
   mxArray *c4_b_is_active_c4_Vector_Control_SVPWM_encoderless, const char_T
   *c4_identifier);
  ...
  (SFc4_Vector_Control_SVPWM_encoderlessInstanceStruct *chartInstance)
{
  ...
  chartInstance->c4_is_active_c4_Vector_Control_SVPWM_encoderless = 0U;
}
  ...
  (SFc4_Vector_Control_SVPWM_encoderlessInstanceStruct *chartInstance)
{
  ...
  c4_d_hoistedGlobal =
    chartInstance->c4_is_active_c4_Vector_Control_SVPWM_encoderless;
   ...
   mxArray *c4_st)
{
  ...
  *c4_Tcmc = c4_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c4_u,
  ...
  chartInstance->c4_is_active_c4_Vector_Control_SVPWM_encoderless =
    ...
    "is_active_c4_Vector_Control_SVPWM_encoderless");
  sf_mex_destroy(&c4_u);
  c4_update_debugger_state_c4_Vector_Control_SVPWM_encoderless(chartInstance);
...
static const mxArray *c4_sf_marshallOut(void *chartInstanceVoid, void *c4_inData)
{
  ...
  const mxArray *c4_y = NULL;
  SFc4_Vector_Control_SVPWM_encoderlessInstanceStruct *chartInstance;
  chartInstance = (SFc4_Vector_Control_SVPWM_encoderlessInstanceStruct *)
    chartInstanceVoid;
   ...
   *c4_identifier)
{
  ...
  c4_y = c4_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c4_b_is_active_c4_Vector_Control_SVPWM_encoderless), &c4_thisId);
  sf_mex_destroy(&c4_b_is_active_c4_Vector_Control_SVPWM_encoderless);
  return c4_y;
}
...
/* SFunction Glue Code */
void sf_c4_Vector_Control_SVPWM_encoderless_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c4_Vector_Control_SVPWM_encoderless_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c4_Vector_Control_SVPWM_encoderless
  (void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x4'type','srcId','name','auxInfo'{{M[1],M[7],T\"Tcma\",},{M[1],M[8],T\"Tcmb\",},{M[1],M[9],T\"Tcmc\",},{M[8],M[0],T\"is_active_c4_Vector_Control_SVPWM_encoderless\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 4, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c4_Vector_Control_SVPWM_encoderless_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c4_Vector_Control_SVPWM_encoderless(void
  *chartInstanceVar)
{
  chart_debug_initialization
    (((SFc4_Vector_Control_SVPWM_encoderlessInstanceStruct*) chartInstanceVar)
     ->S,0);
  initialize_params_c4_Vector_Control_SVPWM_encoderless
    ((SFc4_Vector_Control_SVPWM_encoderlessInstanceStruct*) chartInstanceVar);
  initialize_c4_Vector_Control_SVPWM_encoderless
    ((SFc4_Vector_Control_SVPWM_encoderlessInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c4_Vector_Control_SVPWM_encoderless(void
  *chartInstanceVar)
{
  enable_c4_Vector_Control_SVPWM_encoderless
    ((SFc4_Vector_Control_SVPWM_encoderlessInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c4_Vector_Control_SVPWM_encoderless(void
  *chartInstanceVar)
{
  disable_c4_Vector_Control_SVPWM_encoderless
    ((SFc4_Vector_Control_SVPWM_encoderlessInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c4_Vector_Control_SVPWM_encoderless(void
  *chartInstanceVar)
{
  sf_c4_Vector_Control_SVPWM_encoderless
    ((SFc4_Vector_Control_SVPWM_encoderlessInstanceStruct*) chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c4_Vector_Control_SVPWM_encoderless(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c4_Vector_Control_SVPWM_encoderless
    ((SFc4_Vector_Control_SVPWM_encoderlessInstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c4_Vector_Control_SVPWM_encoderless
    ();                                /* state var info */
...
extern void sf_internal_set_sim_state_c4_Vector_Control_SVPWM_encoderless
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c4_Vector_Control_SVPWM_encoderless
    ((SFc4_Vector_Control_SVPWM_encoderlessInstanceStruct*)
...
static const mxArray*
  sf_opaque_get_sim_state_c4_Vector_Control_SVPWM_encoderless(SimStruct* S)
{
  return sf_internal_get_sim_state_c4_Vector_Control_SVPWM_encoderless(S);
}

static void sf_opaque_set_sim_state_c4_Vector_Control_SVPWM_encoderless
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c4_Vector_Control_SVPWM_encoderless(S, st);
}

static void sf_opaque_terminate_c4_Vector_Control_SVPWM_encoderless(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc4_Vector_Control_SVPWM_encoderlessInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c4_Vector_Control_SVPWM_encoderless
      ((SFc4_Vector_Control_SVPWM_encoderlessInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc4_Vector_Control_SVPWM_encoderless
    ((SFc4_Vector_Control_SVPWM_encoderlessInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c4_Vector_Control_SVPWM_encoderless(SimStruct
  *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c4_Vector_Control_SVPWM_encoderless
      ((SFc4_Vector_Control_SVPWM_encoderlessInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c4_Vector_Control_SVPWM_encoderless(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct =
...
static void mdlRTW_c4_Vector_Control_SVPWM_encoderless(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c4_Vector_Control_SVPWM_encoderless(SimStruct *S)
{
  SFc4_Vector_Control_SVPWM_encoderlessInstanceStruct *chartInstance;
  chartInstance = (SFc4_Vector_Control_SVPWM_encoderlessInstanceStruct *)malloc
    (sizeof(SFc4_Vector_Control_SVPWM_encoderlessInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c4_Vector_Control_SVPWM_encoderless;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c4_Vector_Control_SVPWM_encoderless;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c4_Vector_Control_SVPWM_encoderless;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c4_Vector_Control_SVPWM_encoderless;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c4_Vector_Control_SVPWM_encoderless;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c4_Vector_Control_SVPWM_encoderless;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c4_Vector_Control_SVPWM_encoderless;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c4_Vector_Control_SVPWM_encoderless;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c4_Vector_Control_SVPWM_encoderless;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c4_Vector_Control_SVPWM_encoderless;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c4_Vector_Control_SVPWM_encoderless;
...
void c4_Vector_Control_SVPWM_encoderless_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c4_Vector_Control_SVPWM_encoderless(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c4_Vector_Control_SVPWM_encoderless(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c4_Vector_Control_SVPWM_encoderless(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c4_Vector_Control_SVPWM_encoderless_method_dispatcher.\n"
