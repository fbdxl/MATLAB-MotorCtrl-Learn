...
#define S_FUNCTION_NAME TeCurveSignalGen
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
/* %%%-SFUNWIZ_defines_Changes_BEGIN --- EDIT HERE TO _END */
#define NUM_INPUTS            5
/* Input Port  0 */
#define IN_PORT_0_NAME        nrpm
...
/* Input Port  3 */
#define IN_PORT_3_NAME        StaticFCoef
...
/* Input Port  4 */
#define IN_PORT_4_NAME        KpLoadCurve
...
/* Output Port  0 */
#define OUT_PORT_0_NAME       TLCurveOut
...
{
    const real_T *nrpm = (real_T *) ssGetInputPortRealSignal(S, 0);
    const real_T *NormRpm = (real_T *) ssGetInputPortRealSignal(S, 1);
    const real_T *TeNorm = (real_T *) ssGetInputPortRealSignal(S, 2);
    const real_T *StaticFCoef = (real_T *) ssGetInputPortRealSignal(S, 3);
    const real_T *KpLoadCurve = (real_T *) ssGetInputPortRealSignal(S, 4);
    real_T *TLCurveOut = (real_T *) ssGetOutputPortRealSignal(S, 0);
    const real_T *xD = ssGetDiscStates(S);

    TeCurveSignalGen_Outputs_wrapper(nrpm, NormRpm, TeNorm, StaticFCoef, KpLoadCurve, TLCurveOut, xD);
...
static void mdlUpdate(SimStruct *S, int_T tid)
{
    ...
    TeCurveSignalGen_Update_wrapper(nrpm, NormRpm, TeNorm, StaticFCoef, KpLoadCurve, TLCurveOut, xD);
