 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Tue Oct 04 13:55:53 2022
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME TorqueRefGen
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
/* %%%-SFUNWIZ_defines_Changes_BEGIN --- EDIT HERE TO _END */
#define NUM_INPUTS            9
/* Input Port  0 */
#define IN_PORT_0_NAME        RiseTime
...
/* Input Port  1 */
#define IN_PORT_1_NAME        FallTime
...
/* Input Port  2 */
#define IN_PORT_2_NAME        NormalValue
...
/* Input Port  3 */
#define IN_PORT_3_NAME        DestValuePercent
...
/* Input Port  5 */
#define IN_PORT_5_NAME        RatioOfW
...
/* Input Port  6 */
#define IN_PORT_6_NAME        HarmoTorquePercent
...
/* Input Port  7 */
#define IN_PORT_7_NAME        SpdPercentLmt
...
/* Output Port  0 */
#define OUT_PORT_0_NAME       RampOut
...
{
    const real_T *RiseTime = (real_T *) ssGetInputPortRealSignal(S, 0);
    const real_T *FallTime = (real_T *) ssGetInputPortRealSignal(S, 1);
    const real_T *NormalValue = (real_T *) ssGetInputPortRealSignal(S, 2);
    const real_T *DestValuePercent = (real_T *) ssGetInputPortRealSignal(S, 3);
    const real_T *w = (real_T *) ssGetInputPortRealSignal(S, 4);
    const real_T *RatioOfW = (real_T *) ssGetInputPortRealSignal(S, 5);
    const real_T *HarmoTorquePercent = (real_T *) ssGetInputPortRealSignal(S, 6);
    const real_T *SpdPercentLmt = (real_T *) ssGetInputPortRealSignal(S, 7);
    const real_T *RPMNorm = (real_T *) ssGetInputPortRealSignal(S, 8);
    real_T *RampOut = (real_T *) ssGetOutputPortRealSignal(S, 0);
    const real_T *xD = ssGetDiscStates(S);

    TorqueRefGen_Outputs_wrapper(RiseTime, FallTime, NormalValue, DestValuePercent, w, RatioOfW, HarmoTorquePercent, SpdPercentLmt, RPMNorm, RampOut, xD);
...
static void mdlUpdate(SimStruct *S, int_T tid)
{
    ...
    TorqueRefGen_Update_wrapper(RiseTime, FallTime, NormalValue, DestValuePercent, w, RatioOfW, HarmoTorquePercent, SpdPercentLmt, RPMNorm, RampOut, xD);
