...
MODULES         		= DriveCtrlModeBase_data.c mt_modelframework.c rtGetInf.c rtGetNaN.c rt_nonfinite.c
MAKEFILE        		= DriveCtrlModeBase.mk
...
MASTER_ANCHOR_DIR    	= 
START_DIR          		= D:/1_HILModels/5_Drive/Model/CtrlBlock4Sim/DriveCtrlModeBase
S_FUNCTIONS     		= Contator_wrapper.c DCPowerCalc_wrapper.c MechPowerCalc_wrapper.c SineSignalGen_wrapper.c TeCurveSignalGen_wrapper.c TorqueGenSpd_wrapper.c TorqueRefGen_wrapper.c VgGridGen_wrapper.c
S_FUNCTIONS_LIB 		= 
SOLVER          		= 
NUMST           		= 1
TID01EQ         		= 0
...
MODELLIB                  = DriveCtrlModeBaselib.lib
MODELREF_LINK_LIBS   	  = 
MODELREF_INC_PATH         = 
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/DriveCtrlModeBase_MTRealTime_ZYNQ_rtw \
	-I$(MATLAB_ROOT)/extern/include \
	-I$(MATLAB_ROOT)/simulink/include \
	-I$(MATLAB_ROOT)/rtw/c/src \
	-I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common \
