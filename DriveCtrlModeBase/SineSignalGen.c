 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Mon May 16 16:58:01 2022
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME SineSignalGen
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
/* %%%-SFUNWIZ_defines_Changes_BEGIN --- EDIT HERE TO _END */
#define NUM_INPUTS            4
/* Input Port  0 */
#define IN_PORT_0_NAME        DCMag
...
/* Input Port  3 */
#define IN_PORT_3_NAME        dVoltPerSec
...
/* Output Port  0 */
#define OUT_PORT_0_NAME       SineOut
...
{
    const real_T *DCMag = (real_T *) ssGetInputPortRealSignal(S, 0);
    const real_T *ACMag = (real_T *) ssGetInputPortRealSignal(S, 1);
    const real_T *Freq = (real_T *) ssGetInputPortRealSignal(S, 2);
    const real_T *dVoltPerSec = (real_T *) ssGetInputPortRealSignal(S, 3);
    real_T *SineOut = (real_T *) ssGetOutputPortRealSignal(S, 0);
    const real_T *xD = ssGetDiscStates(S);

    SineSignalGen_Outputs_wrapper(DCMag, ACMag, Freq, dVoltPerSec, SineOut, xD);
...
static void mdlUpdate(SimStruct *S, int_T tid)
{
    ...
    SineSignalGen_Update_wrapper(DCMag, ACMag, Freq, dVoltPerSec, SineOut, xD);
