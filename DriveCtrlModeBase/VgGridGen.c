 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Mon May 16 16:58:08 2022
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME VgGridGen
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
/* %%%-SFUNWIZ_defines_Changes_BEGIN --- EDIT HERE TO _END */
#define NUM_INPUTS            5
/* Input Port  0 */
#define IN_PORT_0_NAME        ACLine
...
/* Input Port  2 */
#define IN_PORT_2_NAME        HarmonicNum
...
/* Input Port  3 */
#define IN_PORT_3_NAME        HarmonicMag
...
/* Input Port  4 */
#define IN_PORT_4_NAME        dVoltPerSec
...
/* Output Port  0 */
#define OUT_PORT_0_NAME       VgPhaseA
...
/* Output Port  1 */
#define OUT_PORT_1_NAME       VgPhaseB
...
/* Output Port  2 */
#define OUT_PORT_2_NAME       VgPhaseC
...
{
    const real_T *ACLine = (real_T *) ssGetInputPortRealSignal(S, 0);
    const real_T *Freq = (real_T *) ssGetInputPortRealSignal(S, 1);
    const real_T *HarmonicNum = (real_T *) ssGetInputPortRealSignal(S, 2);
    const real_T *HarmonicMag = (real_T *) ssGetInputPortRealSignal(S, 3);
    const real_T *dVoltPerSec = (real_T *) ssGetInputPortRealSignal(S, 4);
    real_T *VgPhaseA = (real_T *) ssGetOutputPortRealSignal(S, 0);
    real_T *VgPhaseB = (real_T *) ssGetOutputPortRealSignal(S, 1);
    real_T *VgPhaseC = (real_T *) ssGetOutputPortRealSignal(S, 2);
    const real_T *xD = ssGetDiscStates(S);

    VgGridGen_Outputs_wrapper(ACLine, Freq, HarmonicNum, HarmonicMag, dVoltPerSec, VgPhaseA, VgPhaseB, VgPhaseC, xD);
...
static void mdlUpdate(SimStruct *S, int_T tid)
{
    ...
    VgGridGen_Update_wrapper(ACLine, Freq, HarmonicNum, HarmonicMag, dVoltPerSec, VgPhaseA, VgPhaseB, VgPhaseC, xD);
