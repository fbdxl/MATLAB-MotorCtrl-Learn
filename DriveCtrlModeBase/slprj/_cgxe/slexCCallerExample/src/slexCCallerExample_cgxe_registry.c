...
static mxArray* cgxe_get_supported_modules(void)
{
  ...
  checksumData[0] = 2168869689;
  checksumData[1] = 4188143349;
  checksumData[2] = 887086220;
  checksumData[3] = 2331889770;
  ...
  mxArray* prhs[])
{
...

  {
    ...
    checksumData[0] = 1526617532;
    checksumData[1] = 1039869617;
    checksumData[2] = 1882635836;
    checksumData[3] = 1574677851;
...

  {
    ...
    checksumData[0] = 1867792100;
    checksumData[1] = 954523813;
    checksumData[2] = 2633860763;
    checksumData[3] = 1719113453;
...

  {
    ...
    checksumData[0] = 1653753826;
    checksumData[1] = 1151035602;
    checksumData[2] = 1334510573;
    checksumData[3] = 3881813445;
  ...
  mxArray * prhs[])
{
  ...
  if (strcmp(tpChksum, "FHYdnqWNzY9kpx9XFuJztB") == 0) {
    extern mxArray *cgxe_FHYdnqWNzY9kpx9XFuJztB_BuildInfoUpdate(void);
    plhs[0] = cgxe_FHYdnqWNzY9kpx9XFuJztB_BuildInfoUpdate();
    return 1;
  }
  ...
  mxArray * prhs[])
{
  ...
  tpChksum[(sizeof(tpChksum)/sizeof(char)-1)] = '\0';
  if (strcmp(tpChksum, "FHYdnqWNzY9kpx9XFuJztB") == 0) {
    extern mxArray *cgxe_FHYdnqWNzY9kpx9XFuJztB_fallback_info(void);
    plhs[0] = cgxe_FHYdnqWNzY9kpx9XFuJztB_fallback_info();
    return 1;
  }
