 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Tue Feb 22 13:29:05 2022
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME DCPowerCalc
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
/* %%%-SFUNWIZ_defines_Changes_BEGIN --- EDIT HERE TO _END */
#define NUM_INPUTS            5
/* Input Port  0 */
#define IN_PORT_0_NAME        VdcP
...
/* Output Port  0 */
#define OUT_PORT_0_NAME       DCPower_kW
...
/* Output Port  1 */
#define OUT_PORT_1_NAME       DCPowerFlt_kW
...
{
    const real_T *VdcP = (real_T *) ssGetInputPortRealSignal(S, 0);
    const real_T *VdcN = (real_T *) ssGetInputPortRealSignal(S, 1);
    const real_T *IdcP = (real_T *) ssGetInputPortRealSignal(S, 2);
    const real_T *IdcN = (real_T *) ssGetInputPortRealSignal(S, 3);
    const real_T *fCut = (real_T *) ssGetInputPortRealSignal(S, 4);
    real_T *DCPower_kW = (real_T *) ssGetOutputPortRealSignal(S, 0);
    real_T *DCPowerFlt_kW = (real_T *) ssGetOutputPortRealSignal(S, 1);
    const real_T *xD = ssGetDiscStates(S);

    DCPowerCalc_Outputs_wrapper(VdcP, VdcN, IdcP, IdcN, fCut, DCPower_kW, DCPowerFlt_kW, xD);
...
static void mdlUpdate(SimStruct *S, int_T tid)
{
    ...
    DCPowerCalc_Update_wrapper(VdcP, VdcN, IdcP, IdcN, fCut, DCPower_kW, DCPowerFlt_kW, xD);
