 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Tue Feb 22 13:28:46 2022
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME RAMP_FUNCTION
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
/* Input Port  3 */
#define IN_PORT_3_NAME        DestValueRatio
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    const real_T *DestValueRatio = (real_T *) ssGetInputPortRealSignal(S, 3);
    real_T *RampOut = (real_T *) ssGetOutputPortRealSignal(S, 0);
    const real_T *xD = ssGetDiscStates(S);

    RAMP_FUNCTION_Outputs_wrapper(RiseTime, FallTime, NormalValue, DestValueRatio, RampOut, xD);
...
static void mdlUpdate(SimStruct *S, int_T tid)
{
    ...
    RAMP_FUNCTION_Update_wrapper(RiseTime, FallTime, NormalValue, DestValueRatio, RampOut, xD);
