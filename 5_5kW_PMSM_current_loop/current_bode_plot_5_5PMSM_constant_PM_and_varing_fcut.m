...
PM=75;
str=[];
fpiBox=zeros(1,500/100);
fcutBox=zeros(1,500/100);
n=1;
for fcut=100:100:100
    ...
    hline.DisplayName = strcat('fcut=',num2str(fcut),'Hz');
    %axis([-inf,inf,-inf,35]);
    ...
    for n=1:500/100
        ...
        if fpiBox(n) ~= 0
            ...
            semilogx(hgca_Mag,[fcutBox(n),fcutBox(n)],[yrange(1),yrange(2)],'g');
    ...
    semilogx(hgca_Phase,[xlim(1),xlim(2)],[-105,-105],'r--');
